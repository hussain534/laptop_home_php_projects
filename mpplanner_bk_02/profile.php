...
<div class="container">    
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <form method="post" action="loginController.php?task=6">
                <div class="row">
                    <div class="col-sm-12">
        ...
        if(isset($profile))
        {
            ...
            ?>
                        <tr class="table-body">
                            ...
                            <td>
                                <a href="profile.php?pid=<?php echo $profile[$x][0];?>"><span class="glyphicon glyphicon-pencil" style="font-size:x-large;color:grey;"></span></a>
                                <?php
                                    if($profile[$x][2]==1)
                                    {
                                ?>
                                        <a href="loginController.php?task=7&id=<?php echo $profile[$x][0];?>&disval=1"><span class="glyphicon glyphicon-arrow-up" style="font-size:x-large;color:#00b0f0;"></span></a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                        <a href="loginController.php?task=7&id=<?php echo $profile[$x][0];?>&disval=0"><span class="glyphicon glyphicon-arrow-down" style="font-size:x-large;color:red;"></span></a>
                                <?php
                                    }
                                ?>
                            </td>
