...
<div class="container">    
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <form method="post" action="loginController.php?task=8">
                <div class="row">
                        ...
                        <tr class="table-body">
                            ...
                            <td>
                                <?php
                                    ...
                                    {
                                ?>
                                    <a href="loginController.php?task=9&id=<?php echo $access[$x][0];?>&disval=1"><span class="glyphicon glyphicon-arrow-up" style="font-size:x-large;color:#00b0f0;"></span></a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                    <a href="loginController.php?task=9&id=<?php echo $access[$x][0];?>&disval=0"><span class="glyphicon glyphicon-arrow-down" style="font-size:x-large;color:red;"></span></a>
                                <?php        
                                    }
                                ?>
                            </td>
