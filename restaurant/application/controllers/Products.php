    ...
    */
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
			...
			$img = '<img src="'.base_url($value['image']).'" alt="'.$value['name'].'" class="img-rounded" width="50" height="50" />';
        ...
        $html = '<!-- Main content -->
                    ...
                    <div class="wrapper">
                      <section class="invoice">
                          <button onclick="window.history.back()" class="btn btn-success" style="float:right">Go Back</button>
                        <div class="row">
                        ';
                                    ...
                                    <div class="product-info">
                                        ...
                                        if(count($v['products']) > 0) {
                                            foreach ($v['products'] as $p_key => $p_value) {
                                                $html .= '<br><div class="product-detail">
                                                            <div class="product-name" style="display:inline-block;">
                                                                <img src=../'.$p_value['image'].' style="width:80%">
                                                                <br>
                                                                <b>'.$p_value['name'].'</b>
                                                                
                                                            </div></br>
                                                            <div class="product-price" style="display:inline-block;float:left;">
                                                                <p>'.$company_currency . ' ' . $p_value['price'].'</p>
                                                            </div>
                                                        </div>';
                                            }
                                        }
