...
<div class="cycle-slideshow" 
    ...
    <div class="slide" data-cycle-fx="flipHorz">
        ...
        <div class="caption" style="top:70%;">
            ...
            <div class="sliderContent">
                <span style="font-size:30px;letter-spacing:.5em;">SERVICIOS DE CONSULTORÍA</span><br><br>
                <span style="font-size:14px;letter-spacing:.5em;">PREPÁRATE PARA COMPETIR</span>
    ...
    <div class="slide" data-cycle-fx="flipHorz">
        ...
        <div class="caption" style="top:70%;">
            ...
            <div class="sliderContent">
                ...
                <span style="font-size:14px;letter-spacing:.5em;">UTILIZA LA TECNOLOGÍA DE ÚLTIMA GENERACIÓN</span>
                <!-- <h2>HTML5 , CSS3, PHP , AJAX , JOOMLA, WORDPRESS</h2> -->
                <!-- <h3 style="color:#76913c;">Read More</h3> -->
            </div>
            <!-- <h1>Marriage</h1>
    ...
    <div class="slide" data-cycle-fx="flipHorz">
        ...
        <div class="caption" style="top:70%;">
            ...
            <div class="sliderContent">
                ...
                <span style="font-size:14px;letter-spacing:.5em;">ASEGURAR ALTA DISPONIBILIDAD DE SERVCIO</span>
                <!-- <h2>HTML5 , CSS3, PHP , AJAX , JOOMLA, WORDPRESS</h2> -->
                <!-- <h3 style="color:#76913c;">Read More</h3> -->
            </div>
            <!-- <h1>Marriage</h1>
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <div class="flip flipTitle">
                <span style="font-size:18px">CONSULTORÍA</span>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="flip">                
...
<div class="container" style="width:100%;margin:auto;">      
    <div class="row">
        <div class="col-sm-12 myLabel">
            <h1>NUESTROS PROYECTOS / NUESTRO CLIENTES</h1>
        </div>
    </div>
</div>
<div class="container" style="width:100%;margin:auto;"> 
