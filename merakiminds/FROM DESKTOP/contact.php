            ...
            <form method="post" action="contact_submit.php">
                ...
                <?php
                    if(isset($messsage))
                        echo '<h4>'.$messsage.'</h4>';
                ?>
                <input type="text" class="form-control" id="contact_user" name="contact_user" placeholder="Escriba su nombre" required>
                <input type="text" class="form-control" id="contact_email" name="contact_email" placeholder="Escriba su correo electrónico" required>
                <textarea class="form-control" name="contact_msg" placeholder="Escriba su mensaje" rows="2" required></textarea>
