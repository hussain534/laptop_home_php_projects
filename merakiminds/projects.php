...
<div class="cycle-slideshow" 
    ...
    <div class="slide" data-cycle-fx="flipHorz">
        ...
        <div class="caption" style="top:70%">
            ...
            <div class="sliderContent">
                <span style="font-size:25px;letter-spacing:.5em;float:left">NUESTROS CLIENTES</span><br><hr><span style="font-size:25px;letter-spacing:.5em;float:right">NUESTROS PROYECTOS</span><br><br>
