<?php
    ...
    if(isset($_SESSION["tasks"]))
    {
        ...
        $tasks = $controller->getSearchData($databasecon,"",$DEBUG_STATUS);
        ...
        <form method="post" action="controller.php?controller=4&task=0">
            ...
            <div class="row">
                <div class="col-sm-12 inputData">
                    <label for="baseconocimiento">BUSQUEDA EN BASE DE CONOCIMIENTO(<span class="mandatoryCheck">*</span>)</label>                
                    <input type="text" class="form-control" id="searchParam" name="searchParam" placeholder="Ingresa palabras separados con ; para buscar base de conocimiento. ejemplo: cpu;stress">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
