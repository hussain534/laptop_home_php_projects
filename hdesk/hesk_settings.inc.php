<?php
// Settings file for HESK 2.7.6

// ==> GENERAL

// --> General settings
$hesk_settings['site_title']='IM-HELPDESK';
$hesk_settings['site_url']='http://localhost';
$hesk_settings['hesk_title']='Help Desk';
$hesk_settings['hesk_url']='http://localhost/hdesk';
$hesk_settings['webmaster_mail']='hussain.mm.2006@gmail.com';
$hesk_settings['noreply_mail']='hussain.mm.2006@gmail.com';
...
$hesk_settings['db_name']='hdesk';
$hesk_settings['db_user']='merakiprod01';
$hesk_settings['db_pass']='merakiprod01';
$hesk_settings['db_pfix']='hdesk_';
...
$hesk_settings['secimg_sum']='N6URZJM5U4';
...
$hesk_settings['question_ask']='Which of these is an animal: desk, phone, monkey';
...
$hesk_settings['ticket_list']=array('id','trackid','dt','lastchange','category','name','email','subject','status','owner','replies','staffreplies','lastreplier','time_worked');
...
#     DO NOT EDIT BELOW     #
#############################
$hesk_settings['hesk_version']='2.7.6';
