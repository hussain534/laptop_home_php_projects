				        ...
				        <form method="post" action="index.php?view=shop&layout=userProfile" enctype="multipart/form-data">
					        ...
					        <div class="col-sm-2 profileDtl">
                                    ...
                                    <?php 
                                        ...
                                        {
                                            ?>
                                            <img src=<?php echo JURI::root().'media/com_shop/'; ?>images/users/<?php echo $_SESSION["userid"]; ?>.jpg id="uploadImg" class="profileImage" />
                                            <?php
                                        }
                                        else
                                        {
							...
							<div class="col-sm-10">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 itemDtl">
                                        <button type="submit" class="btn btn-success" onclick="return validateEmail()();">Submit</button>
                                    </div>
                                </div>
                            </div>
					    </form>
