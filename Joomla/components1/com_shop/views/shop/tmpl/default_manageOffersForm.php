    ...
    else
    {
    	...
    	if(isset($_SESSION["clientid"]))
    	{
		    ...
		    if(isset($_POST['submitted']))
		    {
				...
				{
					$sqlOfferUpdate = "UPDATE rn_offers SET rn_offer_created_on=now(), 
				...
				{
					$sqlOfferInsert = "INSERT into rn_offers(rn_offer_desc,rn_offer_created_on,rn_offer_start_from,rn_offer_ends_on,rn_client_id) 
					values('".$_POST['rn_item_desc']."',now(),DATE_FORMAT('".$_POST['rn_offer_start_dt']."','%Y-%m-%d'),DATE_FORMAT('".$_POST['rn_offer_end_dt']."','%Y-%m-%d'),
					'".$clientId."')";
					...
					<div class="col-sm-6 itemDtl">
						...
						<div class="row">
							<div class="col-sm-12 itemDtl">
		                        ...
		                        <input type="text" class="form-control dateParam" size=25 value="<?php echo $clientId; ?>">
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12 itemDtl">
...
?>
	<form method="post" action="index.php?view=shop&layout=manageOffersForm" enctype="multipart/form-data">
		...
		<div class="container">            
			<div class="row">
				<div class="col-sm-6 profileDtl">
					<img src=<?php echo JURI::root().'media/com_shop/'; ?>images/no_image.jpg style="width:550px;height:280px;" id="uploadImg" class="profileImage"/>
		            <label for="imgId">Upload / Edit</label>
		            <input type="file" name="fileToUpload" id="fileToUpload">
				</div>
				<div class="col-sm-6 itemDtl">
