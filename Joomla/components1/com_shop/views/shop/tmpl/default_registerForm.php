	...
	<div class="container register" id="register">  
		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<div class="row">
					<div class="col-sm-12 col12 style-text-center">
						<button type="submit" class="btn btn-info registerSubmit" onclick="return validateForm()">Register</button>
						<a href="index.php?view=shop&amp;layout=login" class="link01">LOGIN</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
