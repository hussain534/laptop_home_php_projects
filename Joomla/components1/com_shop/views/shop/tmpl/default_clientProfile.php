                            ...
                            <div class="col-sm-12">
                                <div class="row">
					                <div class="col-sm-3 profileDtl">
                                        ...
                                        {
                                            ?>
                                            <img src=<?php echo JURI::root().'media/com_shop/'; ?>images/clients/<?php echo $rn_client_id; ?>.jpg id="uploadImg" class="profileImage" />
                                            <?php
                                        }
                                        else
                                        {
                                        ...
                                        ?>
                                        	<br>
                                        	<a href="index.php?view=shop&layout=manageItems&pagecount=0" class="submit_button"><button type="button" class="btn btn-success">View Products</button></a>
                                        <?php
                                        	}
                                        ?> 
                                    </div>
