          ...
          <?php 
            ...
            if(mysqli_num_rows($result) > 0)  
            {
              ...
              {  
                ...
                <div class="col-sm-3">
                  <div class="panel panel-primary" style="border:1px solid <?php echo $color;?>">
           ...
           <div class="row">
            <div class="col-sm-12">   
                  <?php
                    ...
                    {
                  ?>       
                  <p class="viewMore"><a href=index.php?view=shop&layout=categoryContainer&pagecount=0&category=<?php echo $viewMoreCategory;?>><button type="button" class="btn btn-info">Click to view more</button></a></p>
                    <?php
                    }
                    else
                    {
