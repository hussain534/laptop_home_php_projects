					...
					<table class="table" id="t1" style="border:1px solid grey;">
						...
						<tbody>
							...
							<?php
								...
								where r.client_id='".$_SESSION["clientid"]."' and r.status_call=1 and r.status_dispatch=0 and order_status=0 group by r.order_num order by r.registration_call desc";
								//echo $sqlSelect.'<br>';
