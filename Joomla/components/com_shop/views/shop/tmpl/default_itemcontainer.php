...
<div class="container"> 
  <div class="row">
    ...
    <?php 
            ...
            ri.rn_price,rc.rn_phone,ri.rn_stock_qty,ri.rn_delivery_time,
            ...
            if(mysqli_num_rows($result) > 0)  
            {
                ...
                ?>
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-12 itemDtl zoom" onclick ="imgWindow(<?php echo $row['rn_id'];?>,<?php echo $row["rn_client_id"];?>)">
                              <!-- <?php 
                                ...
                                {
                              ?>
                              <img src="media/com_shop/images/zoom4.png" style="padding:0;margin:10px;position:absolute;top:-55px;right:-10px;width:45px;float:right">
                              <?php 
                                }
                              ?> -->
                  ...
                  <div class="col-sm-8 itemDtl">
                      <div class="row">
                          ...
                          ?> 
                          <div class="col-sm-12 itemDtl">
                              <a href=index.php?view=shop&layout=addtocart&itemId=<?php echo $itemId;?> class="submit_button"><button type="button" class="btn btn-success btn-success_style">Add to Cart</button></a>
                          </div>
                          <?php
                        }
                        ?>
              ...
              <div class="row">
                          <div class="col-sm-4 itemDtl">
                              ...
                              <input type="text" class="form-control" name="rn_item_name" value="<?php echo $row["rn_item_name"]; ?>" readonly="true">
                          </div>                          
                          <div class="col-sm-4 itemDtl">
                              <label for="rn_stock_qty">Stock Qty</label>
                              <input type="text" class="form-control" name="rn_stock_qty" value="<?php echo $row["rn_stock_qty"]; ?>" readonly="true">
                          </div>
                          <div class="col-sm-4 itemDtl">
                              <label for="rn_delivery_time">Delivery Time</label>
                              <input type="text" class="form-control" name="rn_delivery_time" value="<?php echo $row["rn_delivery_time"]; ?>" readonly="true">
                          </div>
              </div>
              <div class="row">
                          <div class="col-sm-4 itemDtl">
