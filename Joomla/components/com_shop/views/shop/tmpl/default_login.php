	...
	<div class="container login" id="login">  
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-12 col12  style-text-center">
						<button type="submit" class="btn btn-success loginSubmit" title="Click to enter our portal">LOG IN</button>
						<a href="index.php?view=shop&amp;layout=forgetpwd" class="link01" title="Click to request your password"><button type="button" class="btn btn-success loginSubmit" title="Click to enter our portal">FORGOT PASSWORD</button></a>
						<!-- <span class="separatorKey">|</span> -->
						<a href="index.php?view=shop&amp;layout=registerform" class="link01"><button type="button" class="btn btn-success loginSubmit" title="Click to enter our portal">REGISTER</button></a>
					</div>
				</div>
			</div>
			<div class="col-sm-3">
