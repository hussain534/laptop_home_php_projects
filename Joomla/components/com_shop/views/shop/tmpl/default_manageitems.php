	        ...
	        <div class="header">	    
			    <div class="alert loginRegister">
			        <ul>
                        ...
                        <li><a href='index.php?view=shop&layout=managecCart' class="userMenu-link"><span class='glyphicon glyphicon-shopping-cart'></span> CHECKOUT</a></li>
	        ...
	        <div class="container">            
				<div class="row">
					<div class="col-sm-3 profileDtl">
						<?php                                                     
	                        if(file_exists($target_dir . $rn_client_id.'-'.$rn_id.'.jpg'))
	                        {
	                            ...
	                            <div class="details_item" style="margin:3px 0;padding:3px">
                        ...
                        <br>
                        <a href=index.php?view=shop&layout=manageimages&imageId=<?php echo $row["rn_id"];?> class="submit_button"><button type="button" class="btn btn-success btn-success_style">Add Images</button></a>
                        <?php 
                            if($rn_client_id)
                            {
                        ?>
					...
					<div class="col-sm-9 itemDtl">
						...
						<textarea name="rn_item_desc" class="form-control" maxlength=2500 placeholder="Description(Tamano maximo: 2500)" rows="26"><?php echo $rn_item_desc; ?></textarea>
					</div>
                </div>
                <div class="row">
                ...
                <div class="row">
							<div class="col-sm-4 itemDtl">
								<label for="rn_price">Price(with IVA)</label>                                  
                ...
                <div class="row">
							...
							<div class="col-sm-6 itemDtl">
								<label for="rn_offer_end_dt">Offer Ends On</label>                                 
                ...
                <div class="row">
                            ...
                            <div class="col-sm-2 itemDtl">
                                <button type="submit" class="btn btn-success btn-success_style" onclick="return validateForm()">Update</button></a>
                            </div>
                            <div class="col-sm-5 itemDtl">
                            </div>
                </div>
