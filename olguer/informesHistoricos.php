		...
		<div id="tbl_entidad_gestion"></div>
		    ...
		    <div class="row">
		    	<div class="col-sm-6">
		            ...
		            <button type="button" id="buscarInformesVisitasControl" class="btn btn-small btn_center">BUSCAR INFORME VISITAS<span class="glyphicon glyphicon-chevron-right"></span></button>
