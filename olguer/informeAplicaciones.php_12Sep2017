...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            ?> -->
            <br>
            <form action="informeAplicaciones.php?peticion=<?php echo $peticionId;?>&report=<?php echo $reportDtl[0][0];?>" method="post"  enctype="multipart/form-data">
                ...
                <br>
                <input type="hidden" value="<?php echo $reportDtl[0][5];?>" id="id1" name="id1">
                <input type="hidden" value="<?php echo $reportDtl[0][6];?>" id="id2" name="id2">
                <input type="hidden" value="<?php echo $reportDtl[0][7];?>" id="id3" name="id3">
                <input type="hidden" value="<?php echo $reportDtl[0][8];?>" id="id4" name="id4">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <?php        
                            ...
                            {
                        ?>
                            <input type="checkbox" checked="true onchange=addIdReport6(1)"><span style="color:#f5f5f5">&nbsp;SERV. FACT.</span>
                        <?php        
                            }
                        ?>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <?php        
                            ...
                            {
                        ?>
                            <input type="checkbox" checked="true onchange=addIdReport6(2)"><span style="color:#f5f5f5">&nbsp;COMODATO</span>
                        <?php        
                            }
                        ?>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <?php        
                            ...
                            {
                        ?>
                            <input type="checkbox" checked="true onchange=addIdReport6(3)"><span style="color:#f5f5f5">&nbsp;GARANTIA</span>
                        <?php        
                            }
                        ?>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <?php        
                            ...
                            {
                        ?>
                            <input type="checkbox" checked="true onchange=addIdReport6(4)"><span style="color:#f5f5f5">&nbsp;CONTRATO</span>
                        <?php        
                            }
                        ?>
                    </div>
