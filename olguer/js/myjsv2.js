...
{   
    ...
    {   
        ...
        if(service_id==0)
        {
            document.getElementById("error_service_id").innerHTML = "Por favor elige servicio. Elige Cliente primero cuando no muestra servicios!";
                checkErr=99;
        }
        else if(service_id!=1 && service_id!=7)
        {
            ...
            xmlhttp.onreadystatechange = function() 
            {
                ...
                if (this.readyState == 4 && this.status == 200) 
                {
                    //location.reload();
                    //alert(2);
                    document.getElementById("error_service_id").innerHTML ="";
                    document.getElementById("tbl_entidad_solicitud").innerHTML =this.responseText;
                    //alert(3);
                }
                //else
            ...
            alert("BUSCAR NO APLICA PARA INSTALACION DE EQUIPOS Y VISITAS DE CONTROL");
        $('#progress').hide();
    });
    ...
    $("#buscarInformesVisitasControl").click(function () 
    {   
        $('#progress').show();
        //window.document.getElementById("id_equipos").value=0;
        var checkErr=0;
        ...
        xmlhttp.open("GET", "datacontroller.php?dojob=10&metodo=11&client_id="+client_id+"&ciudad_id="+ciudad_id+"&sucursal_id="+sucursal_id+"&sala_id="+sala_id, true);
        //alert(1);
        xmlhttp.send();
        //alert(1);
        $('#progress').hide();
    ...
    {   
        ...
        /*if(dt_ini===null)
        {
            document.getElementById("error_dt_ini").value="Ingresa Fecha Inicio";
            checkErr=1;
        }
        else
        {
        ...
        if(dt_fin==null)
        {
            document.getElementById("error_dt_fin").value="Ingresa Fecha Final";
            checkErr=1;
        }
        else
        {
        ...
        if(checkErr==0)
        {
            ...
            function drawChart() 
            {
              var jsonData = $.ajax(
                    ...
                    else if(estadoPeticion==3)
                    {
                        var options = {
                                        title : 'PETICIONES CERRADA',
                                        //is3D: true,
                                        pieSliceText:'value',
                                        vAxis: {title: 'PETICIONES'},
                                        hAxis: {title: 'TECNICOS'},
                    ...
                    else if(estadoPeticion==99)
                    {
                        var options = {
                                        title : 'PETICIONES TODOS',
                                        //is3D: true,
                                        pieSliceText:'value',
                                        vAxis: {title: 'PETICIONES'},
                                        hAxis: {title: 'TECNICOS'},
    ...
    {   
        ...
        var t = window.document.getElementById("clientId").selectedIndex;
        var tecnico_name = window.document.getElementById("clientId").options[t].text;
        var estadoPeticion = window.document.getElementById("estadoPeticion").value;
        window.document.getElementById("tec_name").value=tecnico_name;
        ...
        if(checkErr==0)
        {
              ...
              var jsonData = $.ajax(
                    ...
                    if(estadoPeticion==1)
                    {
                            var options =   {
                                            title : 'PETICIONES ABIERTO',
                                            vAxis: {title: 'PETICIONES'},
                                            hAxis: {title: 'TECNICO ('+tecnico_name+')'},
                                            seriesType: 'bars',
                                            series: {5: {type: 'bars'}}
                                            };
                    }
            ...
            xmlhttp.onreadystatechange = function() 
            {
                if (this.readyState == 4 && this.status == 200) 
                {
                    document.getElementById("tbl_entidad_clientes").innerHTML =this.responseText;
                }
            };

            xmlhttp.open("GET", "datacontroller.php?dojob=14&metodo=1&clientId="+clientId, true);
            //alert(destino);
            xmlhttp.send();
    ...
    {   
        ...
        var dt_fin = window.document.getElementById("dt_fin").value;
        var clientId = window.document.getElementById("clientId").value;
        var clId = window.document.getElementById("tbl_entidad_clientes").value;
        var t = window.document.getElementById("clientId").selectedIndex;
        var tecnico_name = window.document.getElementById("clientId").options[t].text;
        var estadoPeticion = window.document.getElementById("estadoPeticion").value;
        window.document.getElementById("tec_name").value=tecnico_name;

        var c = window.document.getElementById("tbl_entidad_clientes").selectedIndex;
        var client_name = window.document.getElementById("tbl_entidad_clientes").options[c].text;
        ...
        if(checkErr==0)
        {
            ...
            function drawChart() 
            {
              var jsonData = $.ajax(
                        {
                        url: "getReport4aData.php",
                            data: 'dt_ini='+dt_ini+'&dt_fin='+dt_fin+'&clientId='+clientId+'&estadoPeticion='+estadoPeticion+'&clId='+clId,
                            dataType: "json",
                            async: false
                        }
                    ).responseText;
                    ...
                    vAxis: {title: 'DIAS'},
                    hAxis: {title: 'TECNICO ('+tecnico_name+'); CLIENTE ('+client_name+')'},
                    seriesType: 'bars',
                    series: {5: {type: 'bars'}}
            };
              var chart = new google.visualization.ComboChart(document.getElementById('tbl_entidad_peticiones'));
              chart.draw(data, options);
            }
    ...
    $("#showReport5").click(function () 
    {   
        $('#progress').show();
        var checkErr=0;
        
        //var clientId=0;
        var serviceId = window.document.getElementById("serviceId").value;
        var clientId = window.document.getElementById("clientId").value;
        var dt_ini = window.document.getElementById("dt_ini").value;
        var dt_fin = window.document.getElementById("dt_fin").value;
        ...
        if(checkErr==0)
        {
            ...
            function drawChart() 
            {
              var jsonData = $.ajax(
                        {
                        url: "getReport5Data.php",
                            data: 'serviceId='+serviceId+'&clientId='+clientId+'&dt_ini='+dt_ini+'&dt_fin='+dt_fin,
                            dataType: "json",
                            async: false
                        }
                    ).responseText;
                    ...
                    var data = new google.visualization.DataTable(jsonData);
                    var options = {
                                        title : 'GESTION SERVICIOS POR CLIENTE',
                                        vAxis: {title: 'CLIENTES'},
                                        hAxis: {title: 'PETICIONES'}
                                };
              var chart = new google.visualization.BarChart(document.getElementById('tbl_entidad_gestion'));
              chart.draw(data, options);
            }
    ...
    {    
        ...
        {
            document.getElementById("con_ext").value='0,1,2,3,4,5';
            document.getElementById("sis_ele").value='0,1,2,3,4,5';
            document.getElementById("ver_par").value='0,1,2,3,4,5';
            document.getElementById("sis_hyd").value='0,1,2,3,4,5';
            document.getElementById("ver_fun").value='0,1,2,3,4,5';
            document.getElementById("sis_apo").value='0,1,2,3,4,5';
        } 
        else 
        {
            document.getElementById("con_ext").value='0';
            document.getElementById("sis_ele").value='0';
            document.getElementById("ver_par").value='0';
            document.getElementById("sis_hyd").value='0';
            document.getElementById("ver_fun").value='0';
            document.getElementById("sis_apo").value='0';
        } 
    });
    ...
    {   
        ...
        xmlhttp.open("GET", "excel1.php?estado="+estado+"&dt_ini="+dt_ini+"&dt_fin="+dt_fin, true);
        //alert(destino);
        xmlhttp.send();
    ...
    {   
        ...
        xmlhttp.open("GET", "excel2.php?dt_ini="+dt_ini+"&dt_fin="+dt_fin, true);
        //alert(destino);
        xmlhttp.send();
    ...
    {   
        ...
        xmlhttp.open("GET", "excel3.php?estadoPeticion="+estadoPeticion+"&tipoCliente="+tipoCliente+"&dt_ini="+dt_ini+"&dt_fin="+dt_fin, true);
        //alert(destino);
        xmlhttp.send();
    ...
    {   
        ...
        xmlhttp.open("GET", "excel4.php?estadoPeticion="+estadoPeticion+"&clientId="+clientId+"&dt_ini="+dt_ini+"&dt_fin="+dt_fin+"&tec_name="+tecnico_name, true);
        //alert(destino);
        xmlhttp.send();
...
function getClientTipo()
{
    ...
    xmlhttp.onreadystatechange = function() 
    {
        if (this.readyState == 4 && this.status == 200) 
        {
            ...
            document.getElementById("client_type_id").value=tipo_cliente;
            //alert(tipo_cliente);
            if(tipo_cliente==0)
            {
...
function handleEquipoList()
{
    ...
    {
        var client_type= document.getElementById("client_type_id").value;
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() 
        {
            if (this.readyState == 4 && this.status == 200) 
        ...
        xmlhttp.open("GET", "datacontroller.php?dojob=9&metodo=6&client_type="+client_type, true);
        xmlhttp.send();
        $('#nipro_tecnicos').show();
    }
    else
...
function validateReport6DataBeforeSubmit()
{
    if(document.getElementById("id1").value>0 || document.getElementById("id2").value>0 || document.getElementById("id3").value>0 || document.getElementById("id4").value>0)
    {
    ...
    {
        document.getElementById("error_servicios").innerHTML="Elije uno de los servicios";
        return false;
    }
}

function getClientesEnBaseDelServicio()
{
    try
    {
        ...
        xmlhttp.onreadystatechange = function() 
        {
            if (this.readyState == 4 && this.status == 200) 
            {
                document.getElementById("clientId").innerHTML = this.responseText;              
            }
        };

        xmlhttp.open("GET", "datacontroller.php?dojob=15&metodo=0&serviceId="+serviceId, true);
        xmlhttp.send();
        $('#progress').hide();
    }
    catch(err)
