...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="page_title">PETICIONES GESTIONADAS POR USUARIOS</h2>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <button type="button" id="showReport2" class="btn btn-small btn_center">MOSTRAR REPORTE<span class="glyphicon glyphicon-chevron-right"></span></button>
                </div>
                <div class="col-sm-3">
