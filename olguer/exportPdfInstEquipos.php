<?php
   ...
   $peticionId=0;
    ...
    $pdf->Cell(45,8,"CODIGO CLIENTE",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(50,8,$peticionDtl[0][2],1,0,"L");
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(45,8,"OST.",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(50,8,$reportDtl[0][3],1,1,"L");

    $pdf->Cell(0,5,"",0,1,"C");
    $pdf->SetFont("Arial","B","12");
    /*$test = utf8_encode("PROTOCOLO DE INSTALACIÓN MAQUINA DE HEMODIALISIS");
    $pdf->Cell(0,5,$test,0,1,"C");*/

    //convert special characters
    $text = $controller->manageSpecialCaracter("PROTOCOLO DE INSTALACIÓN MAQUINA DE HEMODIALISIS");
    $pdf->Cell(0,5,$text,0,1,"C");

    //$pdf->Cell(0,5,"PROTOCOLO DE INSTALACIÓN MAQUINA DE HEMODIALISIS",0,1,"C");
    $pdf->Cell(0,5,"",0,1,"C");

    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(55,8,"HOSPITAL/CLINICA",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(135,8,$peticionDtl[0][3],1,1,"L");

    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(45,8,"FECHA DE INSTALACION",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(50,8,$reportDtl[0][4],1,0,"L");
    $pdf->SetFont("Arial","B","10");
    ...
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(45,8,"VERSION DE SOFTWARE",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(50,8,$reportDtl[0][7],1,0,"L");
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(45,8,"TIPO/MODELO:.",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(50,8,$reportDtl[0][6],1,1,"L");


    $pdf->Cell(0,5,"",0,1,"C");
    $pdf->SetFont("Arial","B","12");
    $pdf->Cell(0,5,"PUNTOS A VERIFICAR POR EL SERVICIO TECNICO",0,1,"C");
    $pdf->Cell(0,5,"",0,1,"C");

    for($x=0;$x<count($checklist);$x++)
    {
        $pdf->SetFont("Arial","B","12");
        $pdf->Cell(0,5,"VERIFICACION:",1,1,"L");
        $pdf->SetFont("Arial","","12");
        $pdf->MultiCell(0,5,$checklist[$x][1],1,'L',false);
        ...
        if($checklist[$x][2]==1)
            ...
            $str="NO";
        $pdf->SetFont("Arial","B","12");
        $pdf->Cell(0,5,"ESTADO:",1,1,"L");
        $pdf->SetFont("Arial","","12");
        $pdf->Cell(0,5,$str,1,1,"L");

        $pdf->SetFont("Arial","B","12");
        $pdf->Cell(0,5,"NOTAS:",1,1,"L");
        $pdf->SetFont("Arial","","12");
        $pdf->MultiCell(0,5,$checklist[$x][3],1,'L',false);
        $pdf->Cell(0,5,"",0,1,"C");
        
    }

    if($reportDtl[0][8]==1)
        $str="EQUIPO OPERATIVO";
    else
        $str="EQUIPO AVERIADO";

    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(60,8,"NOTAS(SERVICIO TECNICO)",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(130,8,$str,1,1,"L");

    $pdf->Cell(0,5,"",0,1,"C");
    $pdf->SetFont("Arial","B","12");
    $pdf->Cell(0,5,"NOTAS POR EL CLIENTE(SI LO HAY):",1,1,"L");
    ...
    $pdf->Cell(0,5,"",0,1,"C");
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(95,8,"Firma aceptado/cliente",0,0,"C");
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(95,8,"Firma responsable de instalacion:.",0,0,"C");
    ...
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(95,8,$reportDtl[0][11],0,0,"C");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(95,8,$peticionHist[0][2],0,1,"C");

    

    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(95,8,$peticionDtl[0][3],0,0,"C");
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(95,8,"NIPRO",0,0,"C");
