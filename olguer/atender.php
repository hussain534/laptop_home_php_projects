<?php
	...
	$PERFIL_ID_GERENTE_SISTEC=$PERFIL_GERENTE_SISTEC;
					...
					<div class="row">
						<div class="col-sm-12 hist-dtl">
							...
							?>
								...
								<div class="row">
									<div class="col-sm-4" style="padding:0">
										<?php echo 'TIPO CLIENTE:';?>
									</div>
									<div class="col-sm-8" style="padding:0">
										<?php 
										if($peticionDtl[0][12]==1)
											echo "RENAL";
										else if($peticionDtl[0][12]==2)
											echo "LABORATORIO";
										else
											echo "NO CLASIFICADO";
										?>
						...
						<div class="row">
							<!-- <div class="col-sm-4 text-left">
								<div class="errblock" style="background:transparent">
									<a href="#" data-toggle="modal" data-target="#myModal">CREAR EQUIPO</a>
		            			</div>						
							</div> -->
							<div class="col-sm-8 text-left">
								<div class="errblock" style="background:transparent">
		            				<?php
		            					$linkStr="";
		            					if(isset($equipos) && count($equipos)==0 && $peticionDtl[0][9]==1)
		            						$linkStr='<a href="#" data-toggle="modal" data-target="#myModal">CREAR EQUIPO</a>&nbsp;';

			            				if($peticionDtl[0][12]==2 && $peticionDtl[0][9]!=6 && $_SESSION["client_id"]==1 && $_SESSION["user_perfil"]!=$PERFIL_ID_GERENTE_SISTEC)
			            				{
			            					echo $linkStr;
			            			?>
			            				<a href=informeServicioTecnico.php?peticion=<?php echo $peticionId;?>>ELABORAR INFORME</a>
			            			<?php
			            				}
			            				else if($peticionDtl[0][12]==2 && $peticionDtl[0][9]==6 && $_SESSION["client_id"]==1 && $_SESSION["user_perfil"]!=$PERFIL_ID_GERENTE_SISTEC)
			            				{
			            					echo $linkStr;
			            			?>
			            				<a href=informeAplicaciones.php?peticion=<?php echo $peticionId;?>>ELABORAR INFORME</a>
			            			<?php
			            				}
			            				else
			            				{
			            				...
			            				<?php
			            					...
			            					else if($peticionDtl[0][9]==7 && $_SESSION["client_id"]==1 && $_SESSION["user_perfil"]!=$PERFIL_ID_GERENTE_SISTEC)
			            					{
			            				?>
			            						<a href=mantenimientoVisitas.php?peticion=<?php echo $peticionId;?>>ELABORAR INFORME</a>
			            				<?php
			            					}
			            				}
		            				?>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background:darkgrey !important">
            <div class="modal-header">
                ...
                <h4 class="modal-title">DETALLES DE EQUIPO INSTALADO</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <label for="nombre_equipo_added">NOMBRE:</label>
                        <input type="text" class="form-control bg_lightgreen" maxlength="20" id="nombre_equipo_added" name="nombre_equipo_added" value="" required>
                        <div class="errmsg" id="error_nombre_equipo_added"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <label for="modelo_equipo_added">MODELO:</label>
                        <input type="text" class="form-control bg_lightgreen" maxlength="20" id="modelo_equipo_added" name="modelo_equipo_added" value="" required>
                        <div class="errmsg" id="error_modelo_equipo_added"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-left">
                        <label for="marca_equipo_added">MARCA:</label>
                        <input type="text" class="form-control bg_lightgreen" maxlength="20" id="marca_equipo_added" name="marca_equipo_added" value="" required>
                        <div class="errmsg" id="error_marca_equipo_added"></div>
                    </div>
                </div>
                 <div class="row">
                    <div class="col-sm-12 text-left">
                        <label for="serie_equipo_added">SERIE:</label>
                        <input type="text" class="form-control bg_lightgreen" maxlength="20" id="serie_equipo_added" name="serie_equipo_added" value="" required>
                        <div class="errmsg" id="error_serie_equipo_added"></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" id="addEquipoForPeticion" class="btn btn-default" data-dismiss="modal">CREAR EQUIPO</button>
            </div>
        </div>
