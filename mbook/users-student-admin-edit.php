<?php
    ...
    $students = $controller->getStudentDtlById($databasecon,$_GET["id"],$DEBUG_STATUS);
    if(isset($_GET["err"]))
    {
        if($_GET["err"]==1)
            $msg='<center> Student details modified successfully</center>';
        else
            $msg='<center> Error while modifying student details</center>';
    }
    else 
        $msg='';
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 text-center"><h1>Modify Student Details</h1></div>
    </div>
    <br>
    <br>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <form method="post" action="controller.php?controller=2&task=2" enctype="multipart/form-data">
