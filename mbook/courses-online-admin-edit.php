<?php
    ...
    $data = $controller->getOnlineCourseDtlById($databasecon,$_GET["id"],$DEBUG_STATUS);
    if(isset($_GET["err"]))
    {
        if($_GET["err"]==1)
            $msg='<center> Online course details modified successfully</center>';
        else
            $msg='<center> Error while modifying Online course details</center>';
    }
    else 
        $msg='';
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 text-center"><h1>Modify Online Course Details</h1></div>
    </div>
    <br>
    <br>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form method="post" action="controller.php?controller=4&task=2" enctype="multipart/form-data">
