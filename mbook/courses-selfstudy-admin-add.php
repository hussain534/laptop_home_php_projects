...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 text-center"><h1>Add New Self Study Course</h1></div>
    </div>
    <br>
    <br>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form method="post" action="controller.php?controller=5&task=0" enctype="multipart/form-data">
                <div class="row">
