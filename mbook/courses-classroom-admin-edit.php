<?php
    ...
    $data = $controller->getClassRoomCourseDtlById($databasecon,$_GET["id"],$DEBUG_STATUS);
    if(isset($_GET["err"]))
    {
        if($_GET["err"]==1)
            $msg='<center> Class Room course details modified successfully</center>';
        else
            $msg='<center> Error while modifying Class Room course details</center>';
    }
    else 
        $msg='';
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 text-center"><h1>Modify Class Room Course Details</h1></div>
    </div>
    <br>
    <br>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form method="post" action="controller.php?controller=3&task=2" enctype="multipart/form-data">
                ...
                <div class="row">                    
                    <div class="col-sm-12 inputData">
                        ...
                        <!-- <input type="text" class="form-control" id="description" name="description" value="<?=$data[0][2];?>" placeholder="Course description" required> -->
                        <textarea class="form-control" id="description" name="description" rows="6" placeholder="Course description" required><?=$data[0][2];?></textarea>
