                     ...
                     <?php
                     {
                        ...
                        <?php
                            ...
                            ?>
                                ...
                                <input type="hidden" name="submitted" value="true" /> 
                                <h3 class="modal-title text-center">CREAR USUARIO ETAPA</h3>
                                <input type="text" class="form-control navbar-btn" id="nombre" name="userNombre" value=<?php echo $description;?>>
                                <input type="email" class="form-control navbar-btn" id="email" name="userEmail"  value=<?php echo $user_email;?>>
                                <input type="text" class="form-control navbar-btn" id="pwd" name="userPwd" value="no-pwd">
                                <input type="text" class="form-control navbar-btn" id="telefono" name="userTelefono" value="2222222">
                                <input type="text" class="form-control navbar-btn" id="celular" name="userCelular" value="999999999">
                                <input type="text" class="form-control navbar-btn" id="ubicacion" name="userUbicacion" value="no-ubicacion">
                                <input type="text" class="form-control navbar-btn" id="usuarioRed" name="usuarioRed" value=<?php echo $_POST["userNombre"];?>>
