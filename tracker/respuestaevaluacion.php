<?php
    ...
    $dbTable='respuestaevaluacion';
    if(isset($_GET["pid"]))
    {
        $data = $controladorDB->obtenerDataResEvaluacion($databasecon,$_GET["pid"],$dbTable,$DEBUG_STATUS);
        $id=$data[0][0];
        $nombre=$data[0][1];
        $nivel=$data[0][2];
    }
    ...
    $data = $controladorDB->obtenerDataResEvaluacion($databasecon,0,$dbTable,$DEBUG_STATUS);
...
<div class="container">    
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <form method="post" action="controladorProceso.php?proceso=11&task=0">
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <label>DESC SATISFACCION</label>
                        <input type="nombre" class="form-control navbar-btn" id="nombre" placeholder="NOMBRE" name="nombre" value="<?php echo $nombre;?>"required>
                    </div>
                    <div class="col-sm-4">
                        <label>NIVEL SATISFACCION</label>
                        <input type="nivel" class="form-control navbar-btn" id="nivel" placeholder="NOMBRE" name="nivel" value="<?php echo $nivel;?>"required>
                    </div>
                    <div class="col-sm-2"></div>
                </div>
        ...
        if(isset($data))
        {
            ...
            ?>
                        <tr class="table-body">
                            ...
                            <td>
                                <a href="respuestaevaluacion.php?pid=<?php echo $data[$x][0];?>"><span class="glyphicon glyphicon-pencil" style="font-size:x-large;color:grey;"></span></a>
