	...
	<div class="container-fluid">
		<div class="navbar-header" style="width:90%">
            ...
            ?>
                ...
                <a href="dashboard.php" class="navbar-brand" style="font-size: 45px;padding: 15px 41px;color: chartreuse">TRACKER</logo></a>
            <?php
                }
                else
                {
            ?>
                ...
                <a href="index.php" class="navbar-brand" style="font-size: 45px;padding: 15px 41px;color: chartreuse">TRACKER</a>
            <?php
                }
            ?>			
		</div>  
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <?php
                ...
                //prod
                /*$con=mysqli_connect('127.0.0.1','perftracker','perftracker','perftracker');
                ...
                function get_menu_tree($id_padre) 
                {
                    ...
                    $res=mysqli_query($databasecon,$sqlquery);
