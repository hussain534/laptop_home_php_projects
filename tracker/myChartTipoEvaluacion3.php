...
$sql="SELECT (SELECT nombre FROM c_login l WHERE l.id=dd.id_evaluado) evaluado,AVG(r.satisfaccion) cnt FROM datos_dtl dd, respuestaevaluacion r WHERE dd.habilitado=1 AND r.habilitado=1 AND dd.id_tipoevaluacion=3 AND dd.id_satisfaccion=r.id GROUP BY dd.id_evaluado,dd.id_planevaluacion";
//execute query
