...
<div class="container" style="min-height:700px">    
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <form method="post" action="001_homeController.php?task=1">
                <div class="row">
                    <div class="col-sm-12">
        ...
        if(isset($menu))
        {
            ...
            ?>
                        <tr class="table-body">
                            ...
                            <td>
                                <a href="001_menu.php?mid=<?php echo $menu[$x][0];?>"><span class="glyphicon glyphicon-pencil" style="font-size:x-large;color:grey;"></span></a>
                                <?php
                                    if($menu[$x][4]==1)
                                    {
                                ?>
                                    <a href="001_homeController.php?task=2&id=<?php echo $menu[$x][0];?>&disval=1"><span class="glyphicon glyphicon-arrow-up" style="font-size:x-large;color:#00b0f0;"></span></a>                                
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                    <a href="001_homeController.php?task=2&id=<?php echo $menu[$x][0];?>&disval=0"><span class="glyphicon glyphicon-arrow-down" style="font-size:x-large;color:red;"></span></a>
                                <?php        
                                    }
                                ?>
                            </td>
