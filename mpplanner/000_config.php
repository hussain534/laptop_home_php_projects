<?php
    ...
    $res_code_161="USER UPDATED / INSERTED SUCCESSFULLY";
    $res_code_162="ERROR OCCURED WHILE UPDATING / INSERTING USER";
    $res_code_163="USER DISABLED SUCCESSFULLY";
    $res_code_164="USER ENABLED SUCCESSFULLY";
    $res_code_165="ERROR OCCURED WHILE DISABLING USER";
?>