...
<div class="row mm-container mm-container-back-insession">
    ...
    <div class="col-sm-10 row_no_margin">
        <div class="row text-center">
            <h1>ADMINISTRACIÓN DE INVENTARIO ALMACEN</h1>
        </div>
        <?php
            ...
            <div class="col-sm-12">
                <form action="controller.php?controller=5&task=0" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="input-group">
                                <span class="input-group-addon">COSTO / UNIDAD</span>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <input type="text" id="item_exp_dt" name="item_exp_dt" class="form-control" placeholder="Fecha Expiracion en formato AAAA-MM-DD">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <input type="text" id="item_barcode" name="item_barcode" class="form-control" placeholder="Ingresar codigo del barra">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php if($inventoryItems[$x][11]==0) echo 'DESHABILITADO'; else echo 'HABILITADO'?></td>
                                            <td>
                                                <?php
                                                echo '<a href="#" onclick=habilitarEditInventory("'.$inventoryItems[$x][0].'","'.urlencode($inventoryItems[$x][1]).'","'.urlencode($inventoryItems[$x][2]).'",'.urlencode($inventoryItems[$x][5]).','.$inventoryItems[$x][6].',"'.urlencode($inventoryItems[$x][7]).'","'.urlencode($inventoryItems[$x][3]).'","'.urlencode($inventoryItems[$x][8]).'","'.urlencode($inventoryItems[$x][10]).'","'.urlencode($inventoryItems[$x][12]).'","'.urlencode($inventoryItems[$x][13]).'","'.urlencode($inventoryItems[$x][14]).'","'.urlencode($inventoryItems[$x][15]).'","'.urlencode($inventoryItems[$x][16]).'","'.urlencode($inventoryItems[$x][17]).'")><span class="glyphicon glyphicon-pencil icon_action"></span></a>';
                                                if($inventoryItems[$x][11]==0)
