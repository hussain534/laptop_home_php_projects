...
function habilitarEditInventory(id,name,desc,qty,ppu,iva,category,ruc,fecha_exp,barcode,purchase_price,tipo_gasto,alerta_almacen,alerta_bodega1,alerta_bodega2)
{
    //alert('HI:');
    ...
    document.getElementById("item_pri_godown_min_alert").value=alerta_bodega1;
    document.getElementById("item_sec_godown_min_alert").value=alerta_bodega2;
}
