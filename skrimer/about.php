...
<!-- <div class="row">
    <div class="col-sm-12 text-center" style="background: #555">
        <div>
            <br>
            <br>
            <span class="text4" style="background-color: #5cf3f3;border-radius: 6px;border:1px solid #ccc;padding: 11px 25px;color:darkmagenta">
                VER OTROS MODULOS
            </span>
            <br>
            <br>
