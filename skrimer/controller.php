<?php
    ...
    if(isset($_GET["controller"]))
    {
        ...
        {    
            $err = $controller->gestionInventoryItems($databasecon,$_POST['item_id'],$_POST['item_name'],$_POST['item_category'],$_POST['item_desc'],$_POST['item_qty'],$_POST['item_ppu'],$_POST['item_iva'],$_POST['item_prov_ruc'],$_POST['item_accion'],$_POST['item_exp_dt'],$_POST['item_barcode'],$_POST['item_purchase_price'],$_POST['item_expenditure_type'],$_POST['item_store_min_alert'],$_POST['item_pri_godown_min_alert'],$_POST['item_sec_godown_min_alert'],$DEBUG_STATUS); 
            if($err==0)
            {
