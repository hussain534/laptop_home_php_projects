        ...
        <div class="col-sm-12">
            ...
            ?>
                        <tr class="table-body">
                            ...
                            <td><a href="verConciliacionHistory.php?id=<?php echo $arrConciliacion[$x][0];?>"><span class="glyphicon glyphicon-th-list" style="font-size:x-large;color:grey;"></span>VER DETALLES</a></td>
                        </tr>
