<?php
    ...
    if(isset($_POST["str-busqueda"]))
                            $_SESSION["strBusquedaPuntos"]=$_POST["str-busqueda"];
?>
<style>
    body
    {
                ...
                <div class="col-sm-5 text-right">
                     <form action="puntos.php" method="post">
                        <div class="input-group">
                            <input type="text" class="form-control" name="str-busqueda" value="<?php if(isset($_SESSION["strBusquedaPuntos"])) echo $_SESSION["strBusquedaPuntos"];?>" placeholder="BUSQUEDA RAPIDA">
              ...
              <table class="table">
                ...
                <tbody>
                    <?php
                        ...
                        $userList = $controller->getUserPuntos($databasecon,0,$current_page,$pagination_count,$_SESSION["strBusquedaPuntos"],$DEBUG_STATUS);
                        if(isset($userList) && count($userList)>0)
                        {
                            $total_pages=ceil(count($userList)/$pagination_count);
                            $last_page = $total_pages-1;
                            $userList = $controller->getUserPuntos($databasecon,1,$current_page,$pagination_count,$_SESSION["strBusquedaPuntos"],$DEBUG_STATUS);
