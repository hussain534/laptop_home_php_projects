<?php
    ...
    {
        /*$err_code = $controller->addUser($databasecon,$_POST["user_id"],$_POST["user_nombre"],$_POST["user_apellido"],$_POST["user_email"],$_POST["user_celular"],$DEBUG_STATUS);*/
        $err_code = $controller->addUser($databasecon,$_POST["user_id"],$_POST["user_nombre"],$_POST["user_apellido"],$_POST["user_email"],'',$DEBUG_STATUS);
