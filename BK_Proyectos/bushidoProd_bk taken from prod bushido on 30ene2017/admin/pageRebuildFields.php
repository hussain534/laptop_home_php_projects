<?php
	...
	$schema = array(   
		'reglamento' => array(   
			...
			'archivo' => array('appgini' => 'VARCHAR(40) not null '),
			'descripcion' => array('appgini' => 'VARCHAR(200) not null ')
		),
		'puntos' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'fecha_actividad' => array('appgini' => 'DATE not null '),
			'fecha_ingreso' => array('appgini' => 'VARCHAR(40) '),
			'motivo' => array('appgini' => 'TEXT not null '),
			'puntaje' => array('appgini' => 'INT not null '),
			'impacto' => array('appgini' => 'INT unsigned not null '),
			'emblema' => array('appgini' => 'INT unsigned '),
			'postulante' => array('appgini' => 'INT unsigned not null '),
			'persona' => array('appgini' => 'INT unsigned not null ')
		),
		'impactos' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'puntaje' => array('appgini' => 'FLOAT(10,2) not null unique '),
			'impactos' => array('appgini' => 'VARCHAR(40) not null '),
			'imagen' => array('appgini' => 'VARCHAR(40) not null ')
		),
		'persona' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'usuario' => array('appgini' => 'VARCHAR(40) not null '),
			'nombre' => array('appgini' => 'VARCHAR(40) not null '),
			'apellido' => array('appgini' => 'VARCHAR(40) not null '),
			'correo' => array('appgini' => 'VARCHAR(40) not null '),
			'celular' => array('appgini' => 'VARCHAR(40) not null '),
			'cumpleanos' => array('appgini' => 'DATE not null ')
		)
	);
