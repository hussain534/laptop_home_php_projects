<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'impactos' table. 
	...
	*/
	...
	function impactos_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function impactos_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function impactos_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function impactos_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function impactos_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['puntaje'], $data['impactos']
	...
	*/
	...
	function impactos_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function impactos_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function impactos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function impactos_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function impactos_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function impactos_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function impactos_batch_actions(&$args){
