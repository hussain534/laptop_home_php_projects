<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'reglamento' table. 
	...
	*/
	...
	function reglamento_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function reglamento_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function reglamento_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function reglamento_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function reglamento_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function reglamento_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function reglamento_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function reglamento_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function reglamento_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function reglamento_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function reglamento_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function reglamento_batch_actions(&$args){
