			...
			<?php if(!$_REQUEST['Embedded']){ ?>
				...
				<nav class="navbar navbar-default navbar-fixed-bottom" role="navigation">
					<p class="navbar-text"><small>
						 <a style="font-size: 14px" class="navbar-link" href="http://www.nipro.com.ec" target="_blank"> <center>Desarrollado por: Departamento TIC Nipro Medical Corp. Ecuador - Todos los derechos reservados</center>
						 </a>
					</small></p>
				</nav>
			<?php } ?>
