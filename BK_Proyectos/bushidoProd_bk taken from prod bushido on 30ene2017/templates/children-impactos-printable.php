			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][3]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][3]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="<?php echo $Translation['ImageFolder'] . urlencode($record[3]); ?>" class="img-responsive img-thumbnail"></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
