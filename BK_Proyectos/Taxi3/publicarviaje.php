			...
			<div class="row">
			 	<div class="col-sm-12">
			 		<?php
				        ...
				        else if($isVerified==50)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL Y SU MATRICULA SON RECHAZADOS. POR FAVOR <a href='perfilConductor.php#veh'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";		        	
				        }
				        else if($isVerified==51)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL SE ENCUENTRA RECHAZADO Y SU MATRICULA SE ENCUENTRA APROBADO. POR FAVOR <a href='perfilConductor.php#veh'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";
				        }
				        else if($isVerified==52)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL SE ENCUENTRA RECHAZADA Y SU MATRICULA SE ENCUENTRA PENDIENTE VERIFICACION. POR FAVOR <a href='perfilConductor.php#veh'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";
				        }
				        else if($isVerified==53)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL SE ENCUENTRA APROBADA Y SU MATRICULA SE ENCUENTRA RECHAZADA. POR FAVOR <a href='perfilConductor.php#veh'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";
				        }
				        /*else if($isVerified==54)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL O SU MATRICULA SON APROBADOS. POR FAVOR <a href='perfilConductor.php'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";
				        }*/
				        else if($isVerified==55)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL SE ENCUENTRA APROBADO Y SU MATRICULA SE ENCUENTRA PENDIENTE VERIFICACION. POR FAVOR <a href='perfilConductor.php#veh'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";
				        }
				        else if($isVerified==56)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL SE ENCUENTRA PENDIENTE VERIFICACION Y SU MATRICULA SE ENCUENTRA RECHAZADA. POR FAVOR <a href='perfilConductor.php#veh'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";
				        }
				        else if($isVerified==57)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL SE ENCUENTRA PENDIENTE VERIFICACION Y SU MATRICULA SE ENCUENTRA APROBADO. POR FAVOR <a href='perfilConductor.php#veh'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";
				        }
				        else if($isVerified==58)
				        {
				        	//if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==2))
				        		echo "<div class='alert alert-danger'><center>DETALLES DE AUTOMOVIL Y SU MATRICULA SON PENDIENTES VERIFICACION. POR FAVOR <a href='perfilConductor.php#veh'>ACTUALIZAR O REVISAR</a> AHORA.</center></div>";
				        }				        				        			        
				        else
				        {
			 		?>
