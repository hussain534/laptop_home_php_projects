            ...
            <div class="col-sm-10 inner_body-block">
                <div class="row">
                    <div class="col-sm-12" style="text-align:center">
                    	<h3 style="text-align:center;color:#222;margin-top:1px">PERFIL DEL CONDUCTOR</h3>
                    </div>
                </div>
                        ...
                        <fieldset class="servicepanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    {
                                    ?>
                                        <center><img src=<?php echo $vehDtl[$x][8];?> id="uploadImg2" class="docImage" /></center>
                                        <p style="text-align:center">MATRICULATION</p>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <span class="input-group-addon">MARCA</span>
                                                <input type="text" class="form-control" name="marca" value="<?php echo $vehDtl[$x][1]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <span class="input-group-addon">MODELO</span>
                                                <input type="text" class="form-control" name="modelo" value="<?php echo $vehDtl[$x][2]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <span class="input-group-addon">ANO</span>
                                                <input type="text" class="form-control" name="ano" value="<?php echo $vehDtl[$x][3]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <span class="input-group-addon">NRO ASIENTOS</span>
                                                <input type="text" class="form-control" name="capacidad" value="<?php echo $vehDtl[$x][4]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <span class="input-group-addon">NRO PLACA</span>
                                                <input type="text" class="form-control" name="placa" value="<?php echo $vehDtl[$x][5]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="matriculation" value="<?php echo $vehDtl[$x][6]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
