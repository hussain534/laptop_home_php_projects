		...
		<div class="col-sm-10 inner_body-block">
			<div class="row">
				<div class="col-sm-12">
					...
					<h3 style="text-align:center;color:#222;margin-top:1px">PUBLICAR VIAJE A AEROPUERTO</h3>
				</div>
			</div>
			<br>
			<br>
			 		...
			 		?>
			 			...
			 			<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="input-group">
											...
											<select name="horainiciodisponibilidad" class="selectpicker" id="horainiciodisponibilidad">
								...
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="input-group">
											...
											<select name="duraciondisponible" class="selectpicker" id="duraciondisponible">
							...
							<div class="col-sm-12 planificarviaje">
			       			...
			       			<button type="button" id="btnPublicarViaje" class="btn btn-success btn_center">PUBLICAR VIAJE <span class="glyphicon glyphicon-chevron-right"></span></button>
			       		</div>
			       	<?php
			       		}
			       	?>
