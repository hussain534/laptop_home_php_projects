...
<div class="container inner_body">
	...
	<div class="row">
		...
		<div class="col-sm-10 inner_body-block">
			<div class="row">
				<div class="col-sm-12">
					<center><img src="images/icon_password.png"></center>
					<h3 style="text-align:center;color:#222;margin-top:1px">MI CLAVE</h3>
				</div>
				<div id="message"></div>
				<div class="col-sm-12">
					<div class="row">
					...
					<div class="row">		
						<button type="button" id="btnActualizarClave" class="btn btn-success btn_center">ACTUALIZAR <span class="glyphicon glyphicon-chevron-right"></span></button>
					</div>
				</div>
			</div>
		</div>
