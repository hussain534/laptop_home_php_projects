	...
	<div class="container inner_body" id="estadoReservarViaje">
		...
		<div class="row">
			...
			<div class="col-sm-10 inner_body-block">
				...
				<div class="row">
					<div class="col-sm-12 text-center">
						<button type="button" id="btnAbrirPago" class="btn btn-success btn_center">CONTINUAR A PAGAR <span class="glyphicon glyphicon-chevron-right"></span></button>
					</div>
				</div>
					 	...
					 	<div class="col-sm-12">
					 		<?php
						        ...
						        elseif($isVerified==3)
						        {
						        	...
						        	if(isset($_SESSION['userRole']) and ($_SESSION['userRole']==3))
					 		...
					 		?>
					       			...
					       			<br>
					       			<button type="submit"  class="btn btn-success btn_center">ACCEPTAR VIAJE <span class="glyphicon glyphicon-chevron-right"></span></button>
					       	<?php
					       		}
					       	?>
					    </div>
