                            ...
                            <div class="row">            
                                ...
                                <div class="col-sm-12 planificarviaje">        
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="fechaPago" id="fechaPago" value="<?php echo $pagos[0][7]; ?>">
                                        <div class="errorMsg" id="error_bancoId"></div>
                                    </div>
                                </div>   
                                <div class="col-sm-12 planificarviaje">        
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="docPago" id="docPago" value="<?php echo $pagos[0][6]; ?>">
                                        <div class="errorMsg" id="error_bancoId"></div>
                                    </div>
                                </div>                         
                            </div>                        
