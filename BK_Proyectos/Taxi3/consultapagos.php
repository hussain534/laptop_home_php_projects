...
<div class="container inner_body">
	...
	<div class="row">
		...
		<div class="col-sm-10 inner_body-block">
			<div class="row">
				<div class="col-sm-12">
					<center><img src="images/icon_money.png"></center>
					<h3 style="text-align:center;color:#222;margin-top:1px">ESTADO PAGOS</h3>
				</div>
			</div>
			<div class="col-sm-12">
				<div class="row">
								...
								<?php
									for($x=0;$x<count($viajeDtl);$x++) 
									{
										...
										elseif(isset($viajeDtl[$x][9]) && $viajeDtl[$x][9]==4)
											$str = 'PENDIENTE PAGAR';
										elseif(isset($viajeDtl[$x][9]) && $viajeDtl[$x][9]==7)
											$str = '<b>PAGADO</b><br>AL:'.$viajeDtl[$x][10].'<br>DOC:'.$viajeDtl[$x][11];
