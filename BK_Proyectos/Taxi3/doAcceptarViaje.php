<?php
    ...
    include_once('header.php');
        ...
        $codigoStr = $controller->reservarViaje($databasecon,mt_rand(),$idviaje,$target_dir,$tipoPago,$direccion,$cantpass,$_SESSION["userid"],$eligoretorno,$costo_uio_aero,$costo_aero_uio,$DEBUG_STATUS);
