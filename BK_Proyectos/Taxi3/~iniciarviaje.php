					...
					<div class="col-sm-12 planificarviaje">
						<div class="row">
			        		...
			        		<div class="col-sm-8 btn_inline">
			        			<h5>NOTA IMPORTANTE:Debes tener una disponibilidad de 30 minutos antes de la hora de tu reserva para que puedas ser recogido junto con los demás pasajeros.</h5>
			        		</div>
			        		<div class="col-sm-2">	        			
			        		</div>
			        	</div>						
