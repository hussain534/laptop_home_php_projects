<?php
    ...
    include_once('header.php');
        ...
        $codigoStr = $controller->preReservarViaje($databasecon,$origenViaje,$horaViaje,$target_dir,$tipoPago,$direccion,$cantpass,$_SESSION["userid"],$eligoretorno,$costo_uio_aero,$costo_aero_uio,$DEBUG_STATUS);
        ...
        if($id>0)
        { 
            $target_file = $target_dir .'PagoPic-'.$pago.'-'.$_SESSION["userid"].'.jpg';
...
<div class="container inner_body" id="estadoReservarViaje">
    ...
    <div class="row">
        ...
        <div class="col-sm-10 inner_body-block">
        	<div class="row">
                <div class="col-sm-12">
                	<div class='alert alert-info shopAlert'>
                    	<?php  echo 'Gracias por reservar viaje con ZIELUS. Numero de boleto temporal de su viaje es '.$id.'.<br>
                        Ahora recibirás los datos de tu viaje a tu correo electrónico y luego recibirás los datos de conductor una vez el esta asignada para su viaje. Deben comunicarse para confirmar la hora de viaje 
            ...
            <div class="row">
        	 	<div class="col-sm-12">
        	       	<a href="misreservas.php"><button type="button" class="btn btn-info btn_center">MIS RESERVAS <span class="glyphicon glyphicon-chevron-right"></span></button></a>
        	    </div>
        	</div>
        	<?php
        		}
