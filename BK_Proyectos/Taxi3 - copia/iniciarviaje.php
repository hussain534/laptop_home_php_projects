			...
			<div class="col-sm-3 inner_body-block  option animated slideInRight">
				<div class="row">
					<div class="col-sm-12">
						...
						<h4 style="text-align:center;color:#222;margin-top:1px">BUSCAR VIAJE A AEROPUERTO</h4>
					</div>
				</div>
				<br>
				...
				<div class="row">
							...
							<select name="sector" class="form-control" id="sector"  onchange="showMap(this);" required>
								...
								<?php 
	    							...
	    							for($x=0;$x<count($terminals);$x++)
	    							{
	    								...
	    								echo "<option value='".$terminals[$x][0].':'.$terminals[$x][2].','.$terminals[$x][3]."'>".$terminals[$x][1]."</option>";
	    							}
								?>
		                    </select>
					...
					<div class="col-sm-12 planificarviaje text-justify">
			        	<h5><strong>NOTA IMPORTANTE:</strong></h5>Debes tener una disponibilidad de 30 minutos antes de la hora de tu reserva para que puedas ser recogido junto con los demás pasajeros.
					</div>
					 <br>
			        <div class="col-sm-12 planificarviaje">
			        	<button type="button" id="btnViajes" class="btn btn-info btn_center">BUSCAR VIAJES<span class="glyphicon glyphicon-chevron-right"></span></button>
			        </div>  
			        <div class="col-sm-12 planificarviaje">
			        	<div class="row">
			        		<div class="col-sm-4">	        			
