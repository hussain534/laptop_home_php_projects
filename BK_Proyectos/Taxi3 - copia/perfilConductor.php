                    ...
                    <fieldset class="servicepanel">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                {
                                ?>
                                    <center><img src=<?php echo $vehDtl[$x][7].'?rand='.rand();?> id="uploadImg" class="docImage" style="width:300px;height:300px;box-shadow: 6px 6px 6px grey;"/></center>
                            ...
                            <div class="col-sm-6">
                                ...
                                {
                                ?>
                                    <center><img src=<?php echo $vehDtl[$x][8].'?rand='.rand();?> id="uploadImg" class="docImage" style="width:300px;height:300px;box-shadow: 6px 6px 6px grey;"/></center>
