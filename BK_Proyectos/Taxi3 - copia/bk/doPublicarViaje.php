...
<div class="container">
	...
	?>
            ...
            <div class="row">
        	 	<div class="col-sm-12">
        	       	<a href="mispublicaciones.php"><button type="button" class="btn btn-success btn_center">MIS VIAJES PUBLICADAS <span class="glyphicon glyphicon-chevron-right"></span></button></a>
        	    </div>
        	</div>
	<?php
		}
	...
	?>
            ...
            <div class="row">
        	 	<div class="col-sm-12">
        	       	<a href="publicarviaje.php"><button type="button" class="btn btn-success btn_center">PUBLICAR VIAJE <span class="glyphicon glyphicon-chevron-right"></span></button></a>
        	    </div>
        	</div>
	<?php		
		}
