	...
	<div class="row">
		<div class="col-sm-12">
			<ul class="menu_inner">
				...
				<li><a href="pagocontrol.php">VERIFICAR PAGOS</a></li>
				...
				?>
				<li style="background:transparent;float:right"><a href="#" style="color:#fbc96c;margin-left:10px"><?php echo strtoupper($_SESSION['userEmail']);?></a></li>
			</ul>
		</div>
	</div>
</div>