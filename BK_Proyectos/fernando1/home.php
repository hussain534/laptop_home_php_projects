    ...
    <div class="panel-group">
        <div class="panel panel-default">
            ...
            <div id="collapse1" class="panel-collapse collapse">
                <div class="panel-body">
                    <ul>
                        <li><a href="#"><img src="images/apple-icon-72x72.png" style="width:35px;margin:10px;">LINEAMINETOS DEL BUSHIDO</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            ...
            <div id="collapse2" class="panel-collapse collapse">
                <div class="panel-body">
                    <ul>
                        <li><a href="#"><img src="images/dashboard.png" style="width:35px;margin:10px;">MI PUNTAJE</a></li>                        
                    </ul>                    
