        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="errmsg" id="error_estado"></div>
                </div>
                <div class="col-sm-3">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <button type="button" id="showReport1" class="btn btn-small btn_center">MOSTRAR REPORTE<span class="glyphicon glyphicon-chevron-right"></span></button>
                </div>
            </div>
            <!--  <div class="row">
