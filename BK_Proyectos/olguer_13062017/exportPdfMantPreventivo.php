<?php
   ...
   $peticionId=0;
    ...
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(40,8,"Cargo",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(55,8,$reportDtl[0][4],1,1,"L");
    ...
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(55,8,$reportDtl[0][7],1,1,"L");
    ...
    if(preg_match('/2/',$reportDtl[0][29]))
        $sis_apo=$sis_apo.'Filtro de endotoxinas,';
    if(preg_match('/3/',$reportDtl[0][29]))
        $sis_apo=$sis_apo.'Red de computo/LAN,';
    if(preg_match('/4/',$reportDtl[0][29]))
        $sis_apo=$sis_apo.'Documentacion de soporte,';
    if(preg_match('/5/',$reportDtl[0][29]))
        $sis_apo=$sis_apo.'Verificacion de uso/operador,';

    $pdf->SetFont("Arial","","10");
    $pdf->MultiCell(0,5,$sis_apo ,1,'L',false);
    $pdf->Cell(0,5,"",0,1,"C");
    ...
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(45,12,"Nombre de tecnico.",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(65,12,$peticionHist[0][2],1,0,"L");
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(30,12,"Firma / Sello",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(50,12,"",1,1,"L");
   
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(45,12,"Nombre Recibe",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(65,12,$reportDtl[0][31],1,0,"L");
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(30,12,"Firma / Sello.",1,0,"L");
    $pdf->SetFont("Arial","","10");
    $pdf->Cell(50,12,"",1,1,"L");
