...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="page_title">PETICIONES GESTIONADAS POR CLIENTES</h2>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <select name="tipoCliente" class="form-control" id="tipoCliente" required>
                        <option value=99>AMBOS</option>
                        <option value=1>RENAL</option>
                        <option value=2>LABORATORIO</option>                        
                    </select>
                    <div class="errmsg" id="error_tipoCliente"></div> 
                </div>
                <div class="col-sm-3">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <button type="button" id="showReport3" class="btn btn-small btn_center">MOSTRAR REPORTE<span class="glyphicon glyphicon-chevron-right"></span></button>
                </div>
            </div>
            <!-- <div class="row">
