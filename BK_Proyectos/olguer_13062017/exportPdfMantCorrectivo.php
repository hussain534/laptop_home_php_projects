<?php
   ...
   $peticionId=0;
    ...
    $pdf->Cell(0,5,"",0,1,"C");
    $pdf->SetFont("Arial","B","10");
    $pdf->MultiCell(0,5,"REPUESTOS UTILIZADOS" ,0,'L',false);


    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(45,8,"NOMBRE REPUESTO:",1,0,"L");    
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(30,8,"CANTIDAD:",1,0,"L");
    $pdf->SetFont("Arial","B","10");
    $pdf->Cell(115,8,"DESCRIPCION",1,1,"L");
    ...
    for($z=0;$z<count($partesDtl);$z++)
    {
        ...
        $pdf->SetFont("Arial","","10");
        $pdf->Cell(30,8,$partesDtl[$z][1],1,0,"L");
        $pdf->SetFont("Arial","","10");
        $pdf->Cell(115,8,$partesDtl[$z][2],1,1,"L");
    }
