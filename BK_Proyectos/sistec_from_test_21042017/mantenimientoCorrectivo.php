            ...
            <form action="mantenimientoCorrectivo.php?peticion=<?php echo $peticionId;?>" method="post">
                    ...
                    <div class="col-sm-6">
                         <div class="row">
                            <div class="col-sm-6" style="color:#f5f5f5;">
                                ...
                                <input type="text" class="form-control bg_lightgreen" id="rep_hora_entrada" name="rep_hora_entrada" value="<?php echo $reportDtl[0][3];?>" required>
                                <div class="errmsg" id="error_rep_hora_entrada"></div>
                            </div>
                            <div class="col-sm-6" style="color:#f5f5f5;">
                                <label for="rep_hora_salida">HORA SALIDA(HH:MM AM/PM):</label>
                                <input type="text" class="form-control bg_lightgreen" id="rep_hora_salida" name="rep_hora_salida" value="<?php echo $reportDtl[0][4];?>" required>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 text-left">
                        ...
                        <input type="text" class="form-control bg_lightgreen" id="rep_ciclos" name="rep_ciclos" value="<?php echo $reportDtl[0][5];?>" required>
                ...
                <div class="row">
                    <div class="col-sm-12 text-left" style="color:#f5f5f5;">
                        ...
                        <textarea class="form-control bg_lightgreen" name="rep_desc" id="rep_desc" value="" rows="10" onkeypress="countTextSize()" placeholder="Ingresardescripcion-200 caracteres" maxlength=200 required><?php echo $reportDtl[0][6];?></textarea> 
                ...
                <div class="row">
                    <div class="col-sm-12 text-left" style="color:#f5f5f5;">
                        ...
                        <input type="text" class="form-control bg_lightgreen" id="rep_codigo" name="rep_codigo" value="<?php echo $reportDtl[0][7];?>" required>
                ...
                <div class="row">
                    <div class="col-sm-12 text-left" style="color:#f5f5f5;">
                        ...
                        <input type="text" class="form-control bg_lightgreen" id="rep_cantidad" name="rep_cantidad" value="<?php echo $reportDtl[0][8];?>" required>
                ...
                <div class="row">
                    <div class="col-sm-12 text-left" style="color:#f5f5f5;">
                        ...
                        <textarea class="form-control bg_lightgreen" name="rep_obser" id="rep_obser" value="" rows="10" onkeypress="countTextSize()" placeholder="Ingresar observacion-200 caracteres" maxlength=200 required><?php echo $reportDtl[0][9];?></textarea> 
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-12 text-center">       
                                ...
                                <input type="text" class="form-control bg_lightgreen" id="rep_recibido_por" name="rep_recibido_por" value="<?php echo $reportDtl[0][10];?>" style="text-align: center;" required>
