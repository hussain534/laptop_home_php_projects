					...
					<div class="row">
						<div class="col-sm-6 text-left">
							<div class="errblock" style="background:transparent">
	            				<?php
	            					if($peticionDtl[0][9]==1)
	            					{
	            				?>
	            						<a href=instalacionEquipo.php?peticion=<?php echo $peticionId;?>>GENERAR REPORTE</a>
	            				<?php
	            					}
	            					else if($peticionDtl[0][9]==2)
	            					{
	            				?>
	            						<a href=mantenimientoPreventivo.php?peticion=<?php echo $peticionId;?>>GENERAR REPORTE</a>
	            				<?php
	            					}
	            					else if($peticionDtl[0][9]==5)
	            					{
	            				?>
	            						<a href=mantenimientoCorrectivo.php?peticion=<?php echo $peticionId;?>>GENERAR REPORTE</a>
	            				<?php
	            					}
	            				?>
	            			</div>
