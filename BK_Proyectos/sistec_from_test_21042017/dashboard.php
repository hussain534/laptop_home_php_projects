...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-10">
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<h3><?php if($_SESSION["client_id"]==1 || $_SESSION["tipo_cliente"]==1) echo 'CLIENTE RENALES';?></h3>
				</div>
			</div>
			
			<?php if($_SESSION["client_id"]==1 || $_SESSION["tipo_cliente"]==1)
			{
			?>
			<br>
			<div class="row">
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<h3><?php if($_SESSION["client_id"]==1 || $_SESSION["tipo_cliente"]==2) echo 'CLIENTE LABORATORIOS'; ?></h3>
				</div>
			</div>
			
			<?php if($_SESSION["client_id"]==1 || $_SESSION["tipo_cliente"]==2)
			{
			?>
			<br>
			<div class="row">
