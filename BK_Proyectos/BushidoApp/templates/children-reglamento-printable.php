		...
		<div class="table-responsive">
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][1]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][1]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><?php if($record[1]){ ?><a href="link.php?t=<?php echo $parameters['ChildTable']; ?>&f=archivo&i=<?php echo urlencode($record[$config['child-primary-key-index']]); ?>" target="_blank" class="btn btn-default" title="<?php echo html_attr($record[1]); ?>"><i class="glyphicon glyphicon-file text-info"></i></a><?php } ?></td>
