<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'persona' table. 
	...
	*/
	...
	function persona_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function persona_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function persona_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['usuario'], $data['nombre'], $data['apellido'], $data['correo'], $data['celular'], $data['cumpleanos']
	...
	*/
	...
	function persona_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function persona_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['usuario'], $data['nombre'], $data['apellido'], $data['correo'], $data['celular'], $data['cumpleanos']
	...
	*/
	...
	function persona_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function persona_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function persona_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function persona_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function persona_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function persona_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function persona_batch_actions(&$args){
