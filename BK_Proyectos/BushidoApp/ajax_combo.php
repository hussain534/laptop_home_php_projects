...
*/
	...
	$lookups = array(   
		...
		'puntos' => array(   
			'impacto' => array(
				'parent_table' => 'impactos',
				'parent_pk_field' => 'id',
				'parent_caption' => '`impactos`.`impactos`',
				'parent_from' => '`impactos` ',
				'filterers' => array(),
				'custom_query' => '',
			...
			'emblema' => array(
				'parent_table' => 'impactos',
				'parent_pk_field' => 'id',
				'parent_caption' => '`impactos`.`imagen`',
				'parent_from' => '`impactos` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'postulante' => array(
				'parent_table' => 'persona',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`persona`.`nombre`) || CHAR_LENGTH(`persona`.`apellido`), CONCAT_WS(\'\', `persona`.`nombre`, \' \', `persona`.`apellido`), \'\')',
				'parent_from' => '`persona` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'persona' => array(
				'parent_table' => 'persona',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`persona`.`usuario`), CONCAT_WS(\'\', `persona`.`usuario`, \' \'), \'\')',
				'parent_from' => '`persona` ',
				'filterers' => array(),
				'custom_query' => 'SELECT `persona`.`id`, IF(CHAR_LENGTH(`persona`.`usuario`), CONCAT_WS(\'\', `persona`.`usuario`, \' \'), \'\') FROM `persona` ORDER BY 2',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => true
			)
