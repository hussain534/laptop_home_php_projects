...
<div class="row">
	...
	<div class="col-sm-6 col-lg-4">
		<div class="panel panel-success">
			...
			<div class="panel-heading" style="background-color:  #A81B1D;">
				<h1 class="panel-title" style="background-color:  #A81B1D;"><strong><?php echo $Translation['sign in here']; ?></strong></h1>
			...
			<div class="panel-body">
				<form  method="post" action="index.php">
					<div class="form-group">
						<label class="control-label" for="username" style="font-size: 20px"><?php echo $Translation['username']; ?></label>
						<input class="form-control" name="username" id="username" type="text" placeholder="<?php echo $Translation['username']; ?>" required>
					</div>
					<div class="form-group">
						<label class="control-label" for="password" style="font-size: 20px"><?php echo $Translation['password']; ?></label>
						<input class="form-control" name="password" id="password" type="password" placeholder="<?php echo $Translation['password']; ?>" required>
						<span  class="help-block" style="font-size: 20px"><?php echo $Translation['forgot password']; ?></span>
					</div>
					<div class="checkbox">
						<label class="control-label" for="rememberMe">
							<input style="color : #A81B1D" type="checkbox" name="rememberMe" id="rememberMe" value="1">
					...
					<div class="row">
						<div class="col-sm-offset-3 col-sm-6">
							<button style="background-color:  #A81B1D;" name="signIn" type="submit" id="submit" value="signIn" class="btn btn-primary btn-lg btn-block"><?php echo $Translation['sign in']; ?></button>
						</div>
					</div>
				</form>
			</div>
