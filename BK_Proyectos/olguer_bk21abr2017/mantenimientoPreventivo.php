            ...
            <form action="mantenimientoPreventivo.php?peticion=<?php echo $peticionId;?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" id="user_name" value="No: <?php echo $reportDtl[0][0];?>" style="background: lightgrey;" readonly="true">
                        <div class="errmsg" id="error_user_name"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center"> 
                        ...
                        ?>                       
                       <form method="post" action=storeInWeb.php?peticion=<?php echo $peticionId;?> enctype="multipart/form-data">
                        <center><a href=exportPdfMantPreventivo.php?peticion=<?php echo $peticionId;?> target="_blank">
                            <input type="button" class="btn btn-small btn_center exportWeb" value="EXPORTAR">
                        </a>
                        
                            <input type="file" class="exportWeb" name="fileToUpload" id="fileToUpload">
                            <input type="submit" class="btn btn-small btn_center exportWeb" value="ALMACENAR SITIO WEB"></center>
                        </form>
                        <?php
                        } 
