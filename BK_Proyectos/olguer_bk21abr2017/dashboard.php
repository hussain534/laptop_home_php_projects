<?php
	...
	$PERFIL_ID_JEFE_RENAL=41;
	$PERFIL_ID_JEFE_LAB=40;
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-10">
			...
			<?php if(($_SESSION["client_id"]==1 && $_SESSION["user_perfil"]!=40) || $_SESSION["tipo_cliente"]==1)//40 is the perfil id of jefe laboratory
			{
			?>
			<br>
			<div class="row">
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<h3><?php if(($_SESSION["client_id"]==1 && $_SESSION["user_perfil"]!=41) || $_SESSION["tipo_cliente"]==2) echo 'CLIENTE LABORATORIOS'; ?></h3>
				</div>
			</div>
			
			<?php if(($_SESSION["client_id"]==1 && $_SESSION["user_perfil"]!=$PERFIL_ID_JEFE_RENAL) || $_SESSION["tipo_cliente"]==2)//41 is the perfil id of jefe renal
			{
			?>
			<br>
			<div class="row">
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<h3><?php if($_SESSION["client_id"]==1 || $_SESSION["tipo_cliente"]==0) echo 'CLIENTE NO CLASIFICADOS';?></h3>
				</div>
			</div>
			
			<?php if($_SESSION["client_id"]==1 || $_SESSION["tipo_cliente"]==0)
			{
			?>
			<br>
			<div class="row">
