...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <form action=instalacionEquipo.php?peticion=<?php echo $peticionId;?>&report=<?php echo $reportDtl[0][0];?> method="post" enctype="multipart/form-data">    
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 text-left">
                        ...
                        <input type="text" class="form-control" id="ost" name="ost" value="<?php echo $reportDtl[0][0];?>" style="background: lightgrey;"  readonly="true">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 text-left">
                        ...
                        <input type="text" class="form-control bg_lightgreen" maxlength="50" id="serie" name="serie" value="<?php echo $reportDtl[0][5];?>" required>
                        <div class="errmsg" id="error_cargo"></div>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-sm-6 text-left">
                        ...
                        <input type="text" class="form-control bg_lightgreen" maxlength="50" id="ver_soft" name="ver_soft" value="<?php echo $reportDtl[0][7];?>" required>
                        <div class="errmsg" id="error_responsable"></div>
                    </div>

                    <div class="col-sm-6 text-left">
                        <label for="cargo">TIPO/MODELO:</label>
                        <input type="text" class="form-control bg_lightgreen" maxlength="50" id="modelo" name="modelo" value="<?php echo $reportDtl[0][6];?>" required>
                        <div class="errmsg" id="error_cargo"></div>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 text-left cell_border1">
                        ...
                        <textarea class="form-control bg_lightgreen" id=<?='checklist_desc_'.$x;?> name=<?='checklist_desc_'.$x;?> rows="5" ><?php echo $checklist[$x][1];?></textarea> 
                    </div> 
                    <div class="col-sm-2 text-left cell_border1">
                        <select name=<?='turnos_dia_'.$x;?> class="form-control bg_lightgreen" id=<?='turnos_dia_'.$x;?>>
                            <?php 
                    ...
                    <div class="col-sm-4 text-left cell_border1">
                        <textarea class="form-control bg_lightgreen" id=<?='nota_'.$x;?> name=<?='nota_'.$x;?> rows="5" onkeypress="countTextSize()" placeholder="Ingresar observacion-200 caracteres" maxlength=200><?php echo $checklist[$x][3];?></textarea> 
                    </div>
                </div>
                <br>
                <?php
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-12 text-center">       
                                ...
                                <input type="text" class="form-control bg_lightgreen"  maxlength="50" id="rep_recibido_por" name="rep_recibido_por" value="<?php echo $reportDtl[0][11];?>" style="text-align: center;" required>
