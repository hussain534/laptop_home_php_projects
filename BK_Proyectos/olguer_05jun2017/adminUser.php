		...
		<div class="col-sm-10">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" id="user_name" maxlength="100">
					<div class="errmsg" id="error_user_name"></div>
				</div>
				<div class="col-sm-6">
					<label for="user_email">CORREO ELECTRONICO:</label>
					<input type="email" class="form-control" id="user_email" maxlength="100" required>
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" id="user_tele" maxlength="20">
					<div class="errmsg" id="error_user_tele"></div>
				</div>
				<div class="col-sm-6">
					<label for="user_celular">CELULAR:</label>
					<input type="text" class="form-control" id="user_celular" maxlength="15">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<input type="text" class="form-control" id="user_direccion" maxlength="200">
			...
			<div class="row">
		        ...
		        ?>
		        <div class="col-sm-6">
		        	<label for="tipo_cliente">GESTION DE CLIENTES:</label>
					...
					<div class="errmsg" id="error_tipo_cliente"></div>
		        </div>
		        <?php
		        	}
		        	else
