            ...
            <div class="row">
                 ...
                 <div class="col-sm-10">
                    <form method="post" action="controladorProceso.php?proceso=0&task=0">
                        ...
                        <br>                        
                        <center>
                            <button type="submit" class="btn btn-info btn_center" title="Click to enter our portal">REGISTRAR<span class="glyphicon glyphicon-chevron-right"></span></button>
                            <br>
                            Si tienes cuenta. Haz clic aqui para <a href="index.php">Iniciar Sesion</a>
                        </center>
                    </form>
                </div>
                <div class="col-sm-1"></div>    
