...
<div class="cycle-slideshow" 
    ...
    <div class="slide" data-cycle-fx="flipHorz">
        ...
        <div class="caption" style="top:30%;">
            ...
            <div class="sliderContent">
                <span style="font-size:30px;letter-spacing:.5em;">NUESTRO PARTNERS</span>
...
<div class="container" style="width:80%;margin:auto;">      
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            No necesitas preocuparte mas en servicios de desarrollo personalizados ya que en Manexware, te ofrecemos una personalización en Odoo ERP única, relevante y orientada a objetos que guía a la industria e incremente el mercado.
            <br><br>
            ...
            Posea experiencia en las integraciones de aplicaiones de negocio usando productos de IBM(Message Brokers, Integration Bus, Data Powers, Portal Server, LDAP, etc)
