...
if (!isset($hmenu) || !is_array($hmenu[0])) $hmenu[0] = array();
$hmenu[0] = $hmenu[0] +
...
//if (!isset($hmenu) || !is_array($hmenu[10])) 
  $hmenu[10] = array();
$hmenu[10] = $hmenu[10] +
