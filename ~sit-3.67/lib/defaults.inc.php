...
$CONFIG['application_name'] = 'Incident Tracker';
$CONFIG['application_shortname'] = 'IT!';
...
// The number of minutes to adjust for daylight savings time (DST), usually 60 (one hour)
$CONFIG['dst_adjust'] = 60;
