...
<div class="container">
    ...
    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <?php
                        ...
                        {
                            echo '<a href=doAcceptarViajeDesdeAeropuerto.php?tipoviaje=0&idviaje='.$viajeDtl[0][0].'&cantpass='.$asientes.'&c_viaje='.$_GET["c_viaje"].' style="color:#00b0f0;"><button type="button" class="btn btn-info btn-sm btn_center" id="btnReservarViajeDesdeAeropuerto">RESERVAR <span class="glyphicon glyphicon-chevron-right"></span></button></a>';                    
                        }
                        else //viaje hasta aeropuerto
                        {
                            echo '<a href=reservar.php?tipoviaje=0&idviaje='.$viajeDtl[0][0].'&cantpass='.$_GET["nroasientes"].' style="color:#00b0f0;"><button type="button" class="btn btn-info btn-sm btn_center" id="empressa">RESERVAR <span class="glyphicon glyphicon-chevron-right"></span></button></a>';
                        }
                    ?>                            
                </div>
                <div class="col-sm-4">
        ...
        ?>
            <div class="col-sm-12 text-center">
                <h5>DESEA RESERVAR ESTE VIAJE?</h5>
                <h6>ZIELUS SE ENCARGA ASIGNAR CONDUCTOR PARA USTED SIEMPRE Y CUANDO FECHA-HORA DE VIAJE NO ESTA EN PROXIMO 5 HORAS.</h6>
                
            </div>
        <?php
            
            echo '<a href="preReserve.php?tipoviaje=0&horaViaje='.$_GET["horavuelo"].'&cantpass='.$_GET["nroasientes"].'&origenViaje='.$_GET["sector"].'" style="color:#00b0f0;"><button type="button" class="btn btn-info btn-sm btn_center" id="empressa">RESERVAR <span class="glyphicon glyphicon-chevron-right"></span></button></a>';            
        }
        ?>
    </div>	
</div>