		...
		<div class="col-sm-3 inner_body-block  option animated slideInRight">
			<div class="row">
				<div class="col-sm-12">
					...
					<h4 style="text-align:center;color:#222;margin-top:1px">PUBLICAR VIAJE NACIONAL</h4>
				</div>
			</div>
			<br>
			<br>
			 		...
			 		?>
							...
							<div class="col-sm-12 planificarviaje">
								<div class="form-group test">
									...
									<select name="horaviaje" class="form-control" id="horaviaje" style="width:40%">
							...
							<div class="col-sm-12 planificarviaje text-justify">	
								<br>
								<br>			
								<p>Al publicarse un viaje, se aceptarán automáticamente los <a href="#" class="link01 text-center" >términos  y condiciones</a> del zielus</p>
							</div>
			       			<button type="button" id="btnPublicarViajeNacional" class="btn btn-info btn_center">PUBLICAR VIAJE <span class="glyphicon glyphicon-chevron-right"></span></button>
			       	<?php
			       		}
			       	?>
			    </div>
