        ...
        if($codigoStr==1 && $doUploadFile==1)
        {
            ...
            {                
                ...
                else 
                {
                    ...
                    {
                       $messsage= 'DETALLES DE PAGO GUARDAO CORRECTAMENTE.<br><br><br>';
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">  
                                <div class="form-group">
                                    <span class="input-group-addon">NRO DOCUMNETO DE PAGO DEL BANCO</span>
                            ...
                            <!-- <div class="col-sm-4">  
                                <div class="form-group">
                                    <span class="input-group-addon">MONTO DE PAGO DEL BANCO</span>
                                    <input type="text" class="form-control" name="montoDocumentoPago" id="montoDocumentoPago" placeholder="Ingresar monto de pago en su banco" required="true">
                                </div>                                
                            </div> -->
                            <div class="col-sm-2">
                            </div>
