<?php
    ...
    if($estado>0)
    {
        $message="<br><div class='row'><div class='col-sm-12'>VIAJE(<b>CODIGO:".$estado."</b>) REGISTRADO EXITOSAMENTE. SI YA REALIZO EL PAGO, POR FAVOR CONTINUE CON EL REGISTRO DE PAGO</div></div><br><br>";
