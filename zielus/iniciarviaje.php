						...
						<div class="col-sm-12 planificarviaje">
							<div class="form-group">
								...
								<select name="nroasientessearch" class="form-control" id="nroasientessearch">
			                        <option value="1">COMPRA UN ASIENTO Y PAGA : $12.00</option>
			                        <option value="2">COMPRA DOS ASIENTOS Y PAGA : $20.00</option>
			                        <option value="5">PLAN FAMILIAR (3 o 4 ASIENTOS) Y PAGA : $25.00</option>
			                        <!-- <option value="6">PLAN FAMILIAR 2 (4 PERSONAS) - PAGA : $25.00</option> -->
			                    </select>
					        </div>
						</div>
					</div>
