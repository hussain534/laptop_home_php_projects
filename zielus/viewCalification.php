<?php
    ...
    if(isset($_GET['searchCodigoViaje']))
    {
        $viajeId=$_GET["searchCodigoViaje"];
    }
                		...
                		<div class="col-sm-6">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    {
                                    ?>
                                        <center><img src=<?php echo $usrDtl[6];?> class="profileImage" style="width:350px;height:300px;box-shadow: 6px 6px 6px grey;"/></center>
                                        <center>
                		...
                		<div class="col-sm-6">
                			<?php
                                ...
                                for($x=0;$x<count($vehDtl);$x++)
                                {
                                    ...
                                    {
                                    ?>
                                        <center><img src=<?php echo $vehDtl[$x][7];?> class="docImage" style="width:350px;height:300px;box-shadow: 6px 6px 6px grey;" /></center>
                                        <center>
