...
include_once "{$base_dir}models{$ds}request{$ds}TransactionRequestModel.php";
include_once "{$base_dir}models{$ds}DataSend.php";
include_once("{$base_dir}core{$ds}Crypt{$ds}RSA.php");
include_once("{$base_dir}core{$ds}Crypt{$ds}TripleDES.php");
/*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
...
class PayPhoneEncrypt {
    ...
    public function Execute($model, $applicationId, $callbackUrl = null, $lang = null) {
