...
include_once ("{$base_dir}common{$ds}PayPhoneWebException.php");

include_once ("{$base_dir}models{$ds}request{$ds}SetRequestModel.php");
include_once ("{$base_dir}models{$ds}request{$ds}TokenRequestModel.php");
include_once ("{$base_dir}models{$ds}request{$ds}RefreshTokenRequestModel.php");
include_once ("{$base_dir}models{$ds}response{$ds}ErrorResponseModel.php");
include_once ("{$base_dir}models{$ds}response{$ds}ResultResponseModel.php");
include_once ("{$base_dir}models{$ds}request{$ds}StatusByAppRequestModel.php");

include_once ("{$base_dir}security{$ds}PayPhoneEncrypt.php");
include_once ("{$base_dir}security{$ds}PayPhoneDecrypt.php");
