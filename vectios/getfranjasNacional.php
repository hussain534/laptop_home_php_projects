        ...
        <div class="col-sm-12">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $strfinal=$str2.' '.$str3.' '.$str4;*/
                                        ...
                                        echo '<tr class="warning"><td>'.$viajeDtl[$x][0].'</td><td>'.$viajeDtl[$x][1].'</td><td>'.$viajeDtl[$x][2].'</td><td>'.$viajeDtl[$x][3].'</td><td>'.$viajeDtl[$x][4].'</td><td>'.$viajeDtl[$x][5].'</td><td>'.$viajeDtl[$x][6].'</td><td><a href=reservar_nacional.php?tipoviaje=1&costoviaje='.$viajeDtl[$x][6].'&idviaje='.$viajeDtl[$x][0].'&cantpass='.$_GET["nroasientes"].'><button type="button" class="btn-success btn-sm" id="empressa">RESERVAR <span class="glyphicon glyphicon-chevron-right"></span></button></a></td></tr>';   
            ...
            <div class="row">
                ...
                <div class="col-sm-4 text-center">
                      <?php echo '<a href=reservar_nacional.php?tipoviaje=1&costoviaje='.$viajeDtl[$x][6].'&idviaje='.$viajeDtl[$x][0].'&cantpass='.$_GET["nroasientes"].'><button type="button" class="btn-sm btn-info btn_center" id="empressa">RESERVAR <span class="glyphicon glyphicon-chevron-right"></span></button></a>';?>
                </div>
                <div class="col-sm-4">
                </div>
            </div>
