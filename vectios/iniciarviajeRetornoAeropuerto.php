    ...
    <div class="container inner_body">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 bg-crimson">
                <br>
                <h3 style="text-align:center;color:#FFF;margin-top:1px">PLANIFICAR VIAJE RETORNO A AEROPUERTO</h3>
            </div>
            <div class="col-sm-1">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div data-mh="my-group" class="item col-sm-3 inner_body-block  option animated slideInRight">
                <form method="post" action="programarViajeRetornoAeropuerto.php">
                    <br>
                    ...
                    <div class="row">
                        <div class="col-sm-12 planificarviaje">
                            <div class="form-group">
                                ...
                                <?php
                                    if($nroAsientesRetornoPendientes[0][0]==1)
                                    {
                                ?>
                                    <option value="1">UN ASIENTO</option>
                                <?php
                                    }
                                    else if($nroAsientesRetornoPendientes[0][0]==2)
                                    {
                                ?>
                                    <option value="1">UN ASIENTO</option>
                                ...
                                <?php
                                    ...
                                    else if($nroAsientesRetornoPendientes[0][0]==3)
                                    {
                                ?>
                                    <option value="1">UN ASIENTO</option>
                                    <option value="2">DOS ASIENTOS</option>
                                     <option value="3">TRES ASIETOS</option>
                                <?php
                                    }
                                    else if($nroAsientesRetornoPendientes[0][0]==4)
                                    {
                                ?>
                                    <option value="1">UN ASIENTO</option>
                                    <option value="2">DOS ASIENTOS</option>
                                     <option value="3">TRES ASIETOS</option>
                                     <option value="4">CUATRO ASIETOS</option>
                                <?php
                                    }
                                ?>
