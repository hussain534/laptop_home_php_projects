...
$(document).ready(function()
{
    ...
    $("#nroDocumentoPago").keypress(function (e) 
    {
        if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57) && e.which > 31 && (e.which < 65 || e.which > 90) && (e.which < 97 || e.which > 122)) 
        {
            //display error message
            $("#errorNroDocumentoPago").html("Por favor ingresar solo numeros o caracteres(no permite caracteres especiales)").show();
                   return false;
        }
        else
            $("#errorNroDocumentoPago").hide();
    ...
    $("#tipoPago").on('change', function () 
    {
        ...
        if($('#tipoPago').val()==1 || $('#tipoPago').val()==2)
        {
            $('#accountDtls').show();
            $('#txnBanco').show();
    ...
    {   
        ...
        {
            window.document.getElementById("costoTotal").innerHTML = "<br><br><br><br><h1 style='background:#222;padding:10px;border:1px solid #222;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b>"+(asientesctr*costoAsiento)+"</h1>";
        }
    ...
    {  
        ...
        $("#showPayValue").hide();
        var xmlhttp = new XMLHttpRequest();
        var codigo_pago=document.getElementById("codigo_pago").value;
        var usrCelular=document.getElementById("usrCelular").value;
        //alert('HI::'+codigo_pago);
        xmlhttp.onreadystatechange = function() 
        {
            //alert(this.readyState+"::"+this.state);
            if (this.readyState == 4 && this.status == 200) 
            {
                /*if (this.status == 200) 
                {*/
        ...
        xmlhttp.open("GET", "doPaymentPayPhone.php?codigo_pago="+codigo_pago+"&tipo=5"+"&usrCelular="+usrCelular, true);
    ...
    try
    {
        var cantidadRetorno = window.document.getElementById("nroasientessearch").value;
...
{   
    ...
    else if(asientesctr==6)
    {
        costoIda = 25;
    }
    
    var cantidadRetorno = window.document.getElementById("cantidadRetorno").value;
    //alert(cantidadRetorno);
    if(cantidadRetorno==1)
    {
        window.document.getElementById("return-plan").src="images/plan1.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + (cantidadRetorno * 8))+".00</h1>";
    }
    else if(cantidadRetorno==2)
    {
        window.document.getElementById("return-plan").src="images/plan2.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + (cantidadRetorno * 8))+".00</h1>";
    }
    else if(cantidadRetorno==3)
    {
        window.document.getElementById("return-plan").src="images/plan3.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + (cantidadRetorno * 8))+".00</h1>";
    }
    else if(cantidadRetorno==4)
    {
        window.document.getElementById("return-plan").src="images/plan4.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + (cantidadRetorno * 8))+".00</h1>";
    }
    else if(cantidadRetorno==5)
    {
        window.document.getElementById("return-plan").src="images/plan5.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + 14)+".00</h1>";
    }
    else if(cantidadRetorno==6)
    {
        window.document.getElementById("return-plan").src="images/plan6.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + 18)+".00</h1>";
    }
    else if(cantidadRetorno==7)
    {
        window.document.getElementById("return-plan").src="images/plan7.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + 22)+".00</h1>";
    }
    else if(cantidadRetorno==8)
    {
        window.document.getElementById("return-plan").src="images/plan8.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + 28)+".00</h1>";
    }
    else if(cantidadRetorno==9)
    {
        window.document.getElementById("return-plan").src="images/plan9.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + 26)+".00</h1>";
    }
    else if(cantidadRetorno==10)
    {
        window.document.getElementById("return-plan").src="images/plan10.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + 30)+".00</h1>";
    }
    else if(cantidadRetorno==101)
    {
        window.document.getElementById("return-plan").src="images/plan101.png";
        window.document.getElementById("costoTotal").innerHTML = "<br><h1 style='background:#00b0f0;padding:10px;border:1px solid #00b0f0;color:#FFF'><b>VALOR TOTAL A PAGAR : $ </b> $ "+(costoIda + 15)+".00</h1>";
    }
    else
    {
        window.document.getElementById("return-plan").src="images/plan0.png";
...
function dispRetornoCedulasList() 
{   
    //$("#panelPago").show();
...
{   
    var fechaviajesearch = window.document.getElementById("fechaviajesearch").value;
    var sector = window.document.getElementById("sector").value;
    var terminal = window.document.getElementById("terminal").value;
    var calle_principal=window.document.getElementById("calle_principal").value;
    var numeracion=window.document.getElementById("numeracion").value;
    var calle_secundario=window.document.getElementById("calle_secundario").value;
    var referencia=window.document.getElementById("referencia").value;
    ...
    if(terminal==0)
    {
        document.getElementById("errorTerminal").innerHTML = "Por favor elige su terminal!";
        errcode=1;
    }
    else
...
function validatePlanificarViajeDataBeforeConfirmation2()
{   
    //alert("validatePlanificarViajeDataBeforeConfirmation");
    var cantidadRetorno = window.document.getElementById("nroasientessearch").value;
...
function checkConductorForzadaIsSelected()
{
    if(document.getElementById("conductorForzada").value==0)
    {
        return false;
    }
    else
...
function addToListList(id,asientos, position)
{
    ...
    if(checkConductorIsSelected())
    {
        ...
        //alert('NORMAL:'+conductor_capacity);
    ...
    else if(checkConductorForzadaIsSelected())
    {
        var myList = document.getElementById("id_viaje_selected").value.split(",");
        var asientosSelectedList = document.getElementById("asientos_selected").value.split(",");
        var total_asientos = document.getElementById("total_asientos").value;
        ...
        var conductor_capacity = document.getElementById("conductorForzada").value.split(":")[1];
        var newList="";
        var newAsientosList="";
        var asientosCount=0;
        var ctr=0;
        ...
        //alert('Forzada:'+conductor_capacity);
        if(conductor_capacity<asientosCount)
        {
            alert("Suma de asientos seleccionados exceede numero de asientos disponible para la conductor elejido.")
            document.getElementById("id_viaje_selected").value=myListCopy;
...
function getConductorViajes()
{
    //alert('HI');
    $('#progress').show();
    var id_conductor=document.getElementById("conductor").value;
    var dt_viaje=document.getElementById("horaviaje").value;
    var from_airport=document.getElementById("fromairport").value;
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.onreadystatechange = function() 
    {
        if (this.readyState == 4 && this.status == 200) 
        {
            ...
            document.getElementById("viajesAsignados").innerHTML = this.responseText;
        }
    };

    xmlhttp.open("GET", "datacontroller.php?dojob=0&metodo=0&id_conductor="+id_conductor+"&dt_viaje="+dt_viaje+"&from_airport="+from_airport, true);
    xmlhttp.send();
    $('#progress').hide();
}


function getTerminalsBySector()
{
    var xmlhttp = new XMLHttpRequest();
    var sector = window.document.getElementById("sector").value;
    xmlhttp.onreadystatechange = function() 
    ...
    xmlhttp.open("GET", "getTerminalsBySector.php?sector=" + sector, true);
    xmlhttp.send();
}

function aprobarContacto(idSolicitante)
{
    var ind = "solicitante_"+idSolicitante;
    var err_ind="estadoAprobacion_"+idSolicitante;
    var idSolicitante = window.document.getElementById(ind).value;
    //alert(err_ind);
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.onreadystatechange = function() 
    {
        ...
        {
            //alert(this.responseText);
            document.getElementById(err_ind).innerHTML = this.responseText;
            document.getElementById('btnChange').innerHTML = '<div class="passenger-block"><button type="button"  class="btn btn-sm btn-success" style="border-radius: 5px">ESTA EN CONTACTO <img src="images/addFriend.png" style="width: 36px;top: -3px;position: relative;"></button></div>';
        }
    };
    xmlhttp.open("GET", "datacontroller.php?dojob=0&metodo=1&idSolicitante=" + idSolicitante, true);
    xmlhttp.send();
}
