<?php
    ...
    if(isset($_POST['submitted']))
    {
        ...
        if(isset($_POST["idviaje"]))
            ...
            $idviaje=0;
        if(isset($_POST["cost_trip"]))
            $cost_trip=$_POST["cost_trip"];
        else
            $cost_trip=0;
    ...
    include_once('header.php');
        ...
        $res = $controller->reservarViajeNacional($databasecon,$idviaje,$target_dir,$tipoPago,$direccion,$cantpass,$_SESSION["userid"],$cost_trip,$DEBUG_STATUS);
        
        $data = explode(':', $res);
        $id=$data[0];
        echo '<br><br><br><br><br><br>ID:'.$res;
        echo '<br><br><br><br><br><br>SQL:'.$data[1];
