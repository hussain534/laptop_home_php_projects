			...
			<ul class="nav navbar-nav navbar-right">				
            	...
            	<li><button type="submit" class="btn btn-warning navbar-btn navbar-right" title="Click to enter our portal">BUSCAR <span class="glyphicon glyphicon-chevron-right"></span></button></li>
            	 -->
                            ...
                            <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> PLANIFICAR VIAJE A<b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="iniciarviaje.php">QUITO - AEROPUERTO</a></li>
                                    <li><a href="iniciarviajeCiudad.php">AEROPUERTO - QUITO</a></li>
