<?php
    ...
    /*$estado = $controller->regsiterViajePlanificado($databasecon,$sector,$nroasientessearch,$fechaviajesearch,$calle_principal,$numeracion,$calle_secundario,$referencia,$cantidadRetorno,$cedulas,$DEBUG_STATUS);*/
    //$estado = $controller->regsiterViajePlanificado($databasecon,$sector,$nroasientessearch,$fechaviajesearch,$calle_principal,$numeracion,$calle_secundario,$referencia,$cantidadRetorno,$DEBUG_STATUS);
    $estado = $controller->regsiterViajePlanificado($databasecon,$sector,$terminal,$nroasientessearch,$fechaviajesearch,$calle_principal,$numeracion,$calle_secundario,$referencia,$cantidadRetorno,$DEBUG_STATUS);
    ...
    {
        $message="<br><div class='row'><div class='col-sm-12'>CODIGO DE VIAJE:<b>".$estado."</b> REGISTRADO EXITOSAMENTE.</div></div><br><br>";
    ...
    else
    {
        ...
        $message=$message."<div class='row'><div class='col-sm-12'><a href='programarViajeAeropuerto.php'><button type='button' class='btn btn-default btn_center'>INTENTA DE NUEVO<span class='glyphicon glyphicon-chevron-right'></span></button></a></div></div><br>";
    }
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-sm-8 text-center">
                        <div class='alert alert-success shopAlert'>
                            <?php  echo 'Para confirmar su viaje, por favor realiza pago de su viaje en CUENTA: '.$micuenta[0][0],', del BANCO:'.$micuenta[0][1].' (TIPO CUENTA:'.$micuenta[0][2].') y carga su documento de pago.<br><br> Tambien puede realizar su pago con PAYPHONE en caso de tener cuenta en payphone' ?>
                         </div>
                    </div>
                    <div class="col-sm-2">
                    </div>
