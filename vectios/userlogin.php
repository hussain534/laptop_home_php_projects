    ...
    <div class="row">
        ...
        <div class="col-sm-4 login-register-block">
            <form method="post" action="doLogin.php">
                ...
                <br>
                <h5 class="modal-title text-center" style="font-weight:bolder;">INICIAR SESIÓN: INGRESA TU USUARIO Y CONTRASEÑA</h5>
                ...
                <br>
                <p class="text-center">Al dar click en el botón registrarse ó iniciar sesión estarás aceptando todos los <a href="#" class="link01 text-center" >términos  y condiciones</a> de vectios</p>
