<?php
    ...
    $conductorId = $controller->getConductorId($databasecon,$_GET['viajeId'],$DEBUG_STATUS);
...
<div class="container inner_body" id="estadoReservarViaje">
    ...
    <div class="row">
        ...
        <div class="col-sm-10 bg-crimson">
            <br>
            <h3 style="text-align:center;color:#FFF;margin-top:1px">PERFIL CONDUCTOR</h3>
        </div>
        <div class="col-sm-1">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10 inner_body-block">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#perfil">DETALLES PERSONAL</a></li>
                <li><a data-toggle="tab" href="#automovil">DETALLES AUTOMOVIL</a></li>
            ...
            <div class="tab-content">
                <div id="perfil" class="tab-pane fade in active">
                    <?php
                        $usrDtl = $controller->getPerfil($databasecon,$conductorId,$DEBUG_STATUS);
                    ?>
                                        ...
                                        <center>
                                            ...
                                            <?php echo $usrDtl[1]; ?>
                                                <div class="row">
                                                    <div class="col-sm-12 text-center">
                                                        <?php
                                                             $usrRating = $controller->getCoductorRating($databasecon,$conductorId,$DEBUG_STATUS);
                ...
                <div id="automovil" class="tab-pane fade">
                    ...
                    <?php
                        $vehDtl = $controller->getVehicleDetails($databasecon,$conductorId,$DEBUG_STATUS);
                        if($DEBUG_STATUS)
                        {
                            if(isset($vehDtl))
                                echo count($vehDtl);
                ...
                <div id="identity" class="tab-pane fade">
                    ...
                    <?php
                    $docDtl = $controller->getDocuments($databasecon,$conductorId,$DEBUG_STATUS);
                    if($DEBUG_STATUS)
                    {
                       echo $docDtl[0][2];
                    }
