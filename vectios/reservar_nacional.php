<?php
    ...
    $viajeDtl = $controller->getDetallesViajesNacionalById($databasecon,$idviaje,$cantpass,$DEBUG_STATUS);
	...
	<div class="container inner_body" id="estadoReservarViaje">
		...
		<div class="row">
			...
			<div class="col-sm-10 inner_body-block">
				...
				<div class="row">
					<div class="col-sm-12">
						<input type="hidden" name="cantpass" id="cantpass" value=<?php echo $cantpass;?> />
			            <div class="table-responsive">
							<table class="table">
								...
								<tbody>
									<?php 	
										if(isset($_GET["tipoviaje"]) && $_GET["tipoviaje"]==1)
											echo '<tr class="warning"><td>'.$viajeDtl[0][0].'</td><td>'.$viajeDtl[0][1].'</td><td>'.$viajeDtl[0][3].'</td><td>'.$viajeDtl[0][4].'</td><td>'.$viajeDtl[0][5].'</td><td>'.$viajeDtl[0][6].'</td><td>'.$cantpass.'</td><td>'.$cantpass*$viajeDtl[0][6].'</td></tr>';	
										else
					...
					<input type="hidden" name="asientesctr" id="asientesctr" value=<?php echo $cantpass;?> />
					<?php
					...
					<?php
						...
						{
					?>
					<input type="hidden" name="costoAsiento" id="costoAsiento" value=<?php echo $viajeDtl[0][6];?> />
					<?php
						}
					?>
