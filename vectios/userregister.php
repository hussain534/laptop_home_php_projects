<?php
    ...
    $loginUrl = $helper->getLoginUrl('http://zielus.hutesol.com/fb-callback.php?tipo=0', $permissions);
    ...
    <div class="row">
        ...
        <div class="col-sm-4 login-register-block">
            <form method="post" action="doRegisterAndLogin.php">
                ...
                <br>
                <h5 class="modal-title text-center" style="font-weight:bolder;">CREAR USUARIO EN VECTIOS</h5>
