<?php
    ...
    $estado = $controller->regsiterViajePlanificadoRetornoCiudad($databasecon,$sector,$terminal,$nroasientessearch,$fechaviajesearch,$calle_principal,$numeracion,$calle_secundario,$referencia,$cedulas,$c_viaje,$nroasientesid,$DEBUG_STATUS);
